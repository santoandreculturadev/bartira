...
<section id="contact" class="home-section bg-white">
	...
	<?php
		...
		<table class="table table-striped">
			<thead>
				<label><h2>2019 - Orquestra</h2></label>
				<tr>
					<th>Período</th>
					<th>Público</th>
					<th>Nº Atividades</th>
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_pub_dezembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '769'";
			$pub_dezembro= $wpdb->get_results($sql_pub_dezembro,ARRAY_A);
			echo "<td>".$pub_dezembro[0]['SUM(valor)']."</td>";

			$sql_ativ_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '769'";
			$ativ_dezembro = $wpdb->get_results($sql_ativ_dezembro,ARRAY_A);
			echo "<td>".$ativ_dezembro[0]['COUNT(id)']."</td>";

			$sql_age_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_dezembro = $wpdb->get_results($sql_age_dezembro,ARRAY_A);
			echo "<td>".$age_dezembro[0]['COUNT(id)']."</td>";

			$sql_num_age_dezembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '769'";
			$num_age_dezembro = $wpdb->get_results($sql_num_age_dezembro,ARRAY_A);
			echo "<td>".$num_age_dezembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '769'";
			$num_bairros_dezembro = $wpdb->get_results($sql_num_bairros_dezembro,ARRAY_A);
			echo "<td>".$num_bairros_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_dezembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '769'";
			$per_bairros_dezembro = $wpdb->get_results($sql_per_bairros_dezembro,ARRAY_A);
			echo "<td>".$per_bairros_dezembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 	periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_dezembro = $wpdb->get_results($sql_num_desc_dezembro,ARRAY_A);
			echo "<td>".$num_desc_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		echo "<tr>";
			...
			$sql_pub_novembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '769'";
			$pub_novembro = $wpdb->get_results($sql_pub_novembro,ARRAY_A);
			echo "<td>".$pub_novembro[0]['SUM(valor)']."</td>";

			$sql_ativ_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '769'";
			$ativ_novembro = $wpdb->get_results($sql_ativ_novembro,ARRAY_A);
			echo "<td>".$ativ_novembro[0]['COUNT(id)']."</td>";

			$sql_age_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_novembro = $wpdb->get_results($sql_age_novembro,ARRAY_A);
			echo "<td>".$age_novembro[0]['COUNT(id)']."</td>";

			$sql_num_age_novembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '769'";
			$num_age_novembro = $wpdb->get_results($sql_num_age_novembro,ARRAY_A);
			echo "<td>".$num_age_novembro[0]['SUM(quantidade_prof_sa)']."</td>";
			...
			$sql_per_bairros_novembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '769'";
			$per_bairros_novembro = $wpdb->get_results($sql_per_bairros_novembro,ARRAY_A);
			echo "<td>".$per_bairros_novembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_novembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_novembro = $wpdb->get_results($sql_num_desc_novembro,ARRAY_A);
			echo "<td>".$num_desc_novembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_outubro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '769'";
			$pub_outubro = $wpdb->get_results($sql_pub_outubro,ARRAY_A);
			echo "<td>".$pub_outubro[0]['SUM(valor)']."</td>";

			$sql_ativ_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '769'";
			$ativ_outubro = $wpdb->get_results($sql_ativ_outubro,ARRAY_A);
			echo "<td>".$ativ_outubro[0]['COUNT(id)']."</td>";

			$sql_age_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_outubro = $wpdb->get_results($sql_age_outubro,ARRAY_A);
			echo "<td>".$age_outubro[0]['COUNT(id)']."</td>";

			$sql_num_age_outubro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '769'";
			$num_age_outubro = $wpdb->get_results($sql_num_age_outubro,ARRAY_A);
			echo "<td>".$num_age_outubro[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '769'";
			$num_bairros_outubro = $wpdb->get_results($sql_num_bairros_outubro,ARRAY_A);
			echo "<td>".$num_bairros_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_outubro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '769'";
			$per_bairros_outubro = $wpdb->get_results($sql_per_bairros_outubro,ARRAY_A);
			echo "<td>".$per_bairros_outubro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_outubro = $wpdb->get_results($sql_num_desc_outubro,ARRAY_A);
			echo "<td>".$num_desc_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_setembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '769'";
			$pub_setembro = $wpdb->get_results($sql_pub_setembro,ARRAY_A);
			echo "<td>".$pub_setembro[0]['SUM(valor)']."</td>";

			$sql_ativ_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '769'";
			$ativ_setembro = $wpdb->get_results($sql_ativ_setembro,ARRAY_A);
			echo "<td>".$ativ_setembro[0]['COUNT(id)']."</td>";

			$sql_age_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_setembro = $wpdb->get_results($sql_age_setembro,ARRAY_A);
			echo "<td>".$age_setembro[0]['COUNT(id)']."</td>";

			$sql_num_age_setembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '769'";
			$num_age_setembro = $wpdb->get_results($sql_num_age_setembro,ARRAY_A);
			echo "<td>".$num_age_setembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '769'";
			$num_bairros_setembro = $wpdb->get_results($sql_num_bairros_setembro,ARRAY_A);
			echo "<td>".$num_bairros_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_setembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '769'";
			$per_bairros_setembro = $wpdb->get_results($sql_per_bairros_setembro,ARRAY_A);
			echo "<td>".$per_bairros_setembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_setembro = $wpdb->get_results($sql_num_desc_setembro,ARRAY_A);
			echo "<td>".$num_desc_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_agosto = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '769'";
			$pub_agosto = $wpdb->get_results($sql_pub_agosto,ARRAY_A);
			echo "<td>".$pub_agosto[0]['SUM(valor)']."</td>";

			$sql_ativ_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '769'";
			$ativ_agosto = $wpdb->get_results($sql_ativ_agosto,ARRAY_A);
			echo "<td>".$ativ_agosto[0]['COUNT(id)']."</td>";

			$sql_age_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_agosto = $wpdb->get_results($sql_age_agosto,ARRAY_A);
			echo "<td>".$age_agosto[0]['COUNT(id)']."</td>";

			$sql_num_age_agosto = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '769'";
			$num_age_agosto = $wpdb->get_results($sql_num_age_agosto,ARRAY_A);
			echo "<td>".$num_age_agosto[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '769'";
			$num_bairros_agosto = $wpdb->get_results($sql_num_bairros_agosto,ARRAY_A);
			echo "<td>".$num_bairros_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_agosto = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '769'";
			$per_bairros_agosto = $wpdb->get_results($sql_per_bairros_agosto,ARRAY_A);
			echo "<td>".$per_bairros_agosto[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_agosto = $wpdb->get_results($sql_num_desc_agosto,ARRAY_A);
			echo "<td>".$num_desc_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			...
			$sql_pub_julho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '769'";
			$pub_julho = $wpdb->get_results($sql_pub_julho,ARRAY_A);
			echo "<td>".$pub_julho[0]['SUM(valor)']."</td>";

			$sql_ativ_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '769'";
			$ativ_julho = $wpdb->get_results($sql_ativ_julho,ARRAY_A);
			echo "<td>".$ativ_julho[0]['COUNT(id)']."</td>";

			$sql_age_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_julho = $wpdb->get_results($sql_age_julho,ARRAY_A);
			echo "<td>".$age_julho[0]['COUNT(id)']."</td>";

			$sql_num_age_julho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '769'";
			$num_age_julho = $wpdb->get_results($sql_num_age_julho,ARRAY_A);
			echo "<td>".$num_age_julho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '769'";
			$num_bairros_julho = $wpdb->get_results($sql_num_bairros_julho,ARRAY_A);
			echo "<td>".$num_bairros_julho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_julho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '769'";
			$per_bairros_julho = $wpdb->get_results($sql_per_bairros_julho,ARRAY_A);
			echo "<td>".$per_bairros_julho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_julho = $wpdb->get_results($sql_num_desc_julho,ARRAY_A);
			echo "<td>".$num_desc_julho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_junho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '769'";
			$pub_junho = $wpdb->get_results($sql_pub_junho,ARRAY_A);
			echo "<td>".$pub_junho[0]['SUM(valor)']."</td>";

			$sql_ativ_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '769'";
			$ativ_junho = $wpdb->get_results($sql_ativ_junho,ARRAY_A);
			echo "<td>".$ativ_junho[0]['COUNT(id)']."</td>";

			$sql_age_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_junho = $wpdb->get_results($sql_age_junho,ARRAY_A);
			echo "<td>".$age_junho[0]['COUNT(id)']."</td>";

			$sql_num_age_junho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '769'";
			$num_age_junho = $wpdb->get_results($sql_num_age_junho,ARRAY_A);
			echo "<td>".$num_age_junho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '769'";
			$num_bairros_junho = $wpdb->get_results($sql_num_bairros_junho,ARRAY_A);
			echo "<td>".$num_bairros_junho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_junho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '769'";
			$per_bairros_junho = $wpdb->get_results($sql_per_bairros_junho,ARRAY_A);
			echo "<td>".$per_bairros_junho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_junho = $wpdb->get_results($sql_num_desc_junho,ARRAY_A);
			echo "<td>".$num_desc_junho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_maio = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '769'";
			$pub_maio = $wpdb->get_results($sql_pub_maio,ARRAY_A);
			echo "<td>".$pub_maio[0]['SUM(valor)']."</td>";

		
			$sql_ativ_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '769'";
			$ativ_maio = $wpdb->get_results($sql_ativ_maio,ARRAY_A);
			echo "<td>".$ativ_maio[0]['COUNT(id)']."</td>";

			$sql_age_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_maio = $wpdb->get_results($sql_age_maio,ARRAY_A);
			echo "<td>".$age_maio[0]['COUNT(id)']."</td>";

			$sql_num_age_maio = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '769'";
			$num_age_maio = $wpdb->get_results($sql_num_age_maio,ARRAY_A);
			echo "<td>".$num_age_maio[0]['SUM(quantidade_prof_sa)']."</td>";

		
			$sql_num_bairros_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '769'";
			$num_bairros_maio = $wpdb->get_results($sql_num_bairros_maio,ARRAY_A);
			echo "<td>".$num_bairros_maio[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_maio = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '769'";
			$per_bairros_maio = $wpdb->get_results($sql_per_bairros_maio,ARRAY_A);
			echo "<td>".$per_bairros_maio[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_maio = $wpdb->get_results($sql_num_desc_maio,ARRAY_A);
			echo "<td>".$num_desc_maio[0]['COUNT(DISTINCT(bairro))']."</td>";	
		...
		echo "<tr>";
			...
			$sql_pub_abril = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '769'";
			$pub_abril = $wpdb->get_results($sql_pub_abril,ARRAY_A);
			echo "<td>".$pub_abril[0]['SUM(valor)']."</td>";

			$sql_ativ_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '769'";
			$ativ_abril = $wpdb->get_results($sql_ativ_abril,ARRAY_A);
			echo "<td>".$ativ_abril[0]['COUNT(id)']."</td>";

			$sql_age_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_abril = $wpdb->get_results($sql_age_abril,ARRAY_A);
			echo "<td>".$age_abril[0]['COUNT(id)']."</td>";

			$sql_num_age_abril = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '769'";
			$num_age_abril = $wpdb->get_results($sql_num_age_abril,ARRAY_A);
			echo "<td>".$num_age_abril[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '769'";
			$num_bairros_abril = $wpdb->get_results($sql_num_bairros_abril,ARRAY_A);
			echo "<td>".$num_bairros_abril[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_abril = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '769'";
			$per_bairros_abril = $wpdb->get_results($sql_per_bairros_abril,ARRAY_A);
			echo "<td>".$per_bairros_abril[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 		periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_abril = $wpdb->get_results($sql_num_desc_abril,ARRAY_A);
			echo "<td>".$num_desc_abril[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_marco = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND projeto = '769'";
			$pub_marco = $wpdb->get_results($sql_pub_marco,ARRAY_A);
			echo "<td>".$pub_marco[0]['SUM(valor)']."</td>";

			$sql_ativ_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND projeto = '769'";
			$ativ_marco = $wpdb->get_results($sql_ativ_marco,ARRAY_A);
			echo "<td>".$ativ_marco[0]['COUNT(id)']."</td>";

			$sql_age_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_marco = $wpdb->get_results($sql_age_marco,ARRAY_A);
			echo "<td>".$age_marco[0]['COUNT(id)']."</td>";

			$sql_num_age_marco = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND projeto = '769'";
			$num_age_marco = $wpdb->get_results($sql_num_age_marco,ARRAY_A);
			echo "<td>".$num_age_marco[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND projeto = '769'";
			$num_bairros_marco = $wpdb->get_results($sql_num_bairros_marco,ARRAY_A);
			echo "<td>".$num_bairros_marco[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_marco = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND projeto = '769'";
			$per_bairros_marco = $wpdb->get_results($sql_per_bairros_marco,ARRAY_A);
			echo "<td>".$per_bairros_marco[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_marco = $wpdb->get_results($sql_num_desc_marco,ARRAY_A);
			echo "<td>".$num_desc_marco[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_fevereiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '769'";
			$pub_fevereiro = $wpdb->get_results($sql_pub_fevereiro,ARRAY_A);
			echo "<td>".$pub_fevereiro[0]['SUM(valor)']."</td>";

			$sql_ativ_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '769'";
			$ativ_fevereiro = $wpdb->get_results($sql_ativ_fevereiro,ARRAY_A);
			echo "<td>".$ativ_fevereiro[0]['COUNT(id)']."</td>";

			$sql_age_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_fevereiro = $wpdb->get_results($sql_age_fevereiro,ARRAY_A);
			echo "<td>".$age_fevereiro[0]['COUNT(id)']."</td>";


			$sql_num_age_fevereiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '769'";
			$num_age_fevereiro = $wpdb->get_results($sql_num_age_fevereiro,ARRAY_A);
			echo "<td>".$num_age_fevereiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '769'";
			$num_bairros_fevereiro = $wpdb->get_results($sql_num_bairros_fevereiro,ARRAY_A);
			echo "<td>".$num_bairros_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_fevereiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '769'";
			$per_bairros_fevereiro = $wpdb->get_results($sql_per_bairros_fevereiro,ARRAY_A);
			echo "<td>".$per_bairros_fevereiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_fevereiro = $wpdb->get_results($sql_num_desc_fevereiro,ARRAY_A);
			echo "<td>".$num_desc_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			echo"<td><strong>JAN</strong></td>";
			$sql_pub_janeiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '769'";
			$pub_janeiro = $wpdb->get_results($sql_pub_janeiro,ARRAY_A);
			echo "<td>".$pub_janeiro[0]['SUM(valor)']."</td>";

			$sql_ativ_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '769'";
			$ativ_janeiro = $wpdb->get_results($sql_ativ_janeiro,ARRAY_A);
			echo "<td>".$ativ_janeiro[0]['COUNT(id)']."</td>";

			$sql_age_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_janeiro = $wpdb->get_results($sql_age_janeiro,ARRAY_A);
			echo "<td>".$age_janeiro[0]['COUNT(id)']."</td>";

			$sql_num_age_janeiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '769'";
			$num_age_janeiro = $wpdb->get_results($sql_num_age_janeiro,ARRAY_A);
			echo "<td>".$num_age_janeiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '769'";
			$num_bairros_janeiro = $wpdb->get_results($sql_num_bairros_janeiro,ARRAY_A);
			echo "<td>".$num_bairros_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_janeiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '769'";
			$per_bairros_janeiro = $wpdb->get_results($sql_per_bairros_janeiro,ARRAY_A);
			echo "<td>".$per_bairros_janeiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_janeiro = $wpdb->get_results($sql_num_desc_janeiro,ARRAY_A);
			echo "<td>".$num_desc_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_total = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '769'";
			$pub_total= $wpdb->get_results($sql_pub_total,ARRAY_A);
			echo "<td>".$pub_total[0]['SUM(valor)']."</td>";

			$sql_ativ_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '769'";
			$ativ_total = $wpdb->get_results($sql_ativ_total,ARRAY_A);
			echo "<td>".$ativ_total[0]['COUNT(id)']."</td>";

			$sql_age_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND prof_sa = '1' AND projeto = '769'";
			$age_total = $wpdb->get_results($sql_age_total,ARRAY_A);
			echo "<td>".$age_total[0]['COUNT(id)']."</td>";

			$sql_num_age_total = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '769'";
			$num_age_total = $wpdb->get_results($sql_num_age_total,ARRAY_A);
			echo "<td>".$num_age_total[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '769'";
			$num_bairros_total = $wpdb->get_results($sql_num_bairros_total,ARRAY_A);
			echo "<td>".$num_bairros_total[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_total = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '769'";
			$per_bairros_total = $wpdb->get_results($sql_per_bairros_total,ARRAY_A);
			echo "<td>".$per_bairros_total[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '769'";
			$num_desc_total = $wpdb->get_results($sql_num_desc_total,ARRAY_A);
			echo "<td>".$num_desc_total[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_pub_dezembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '273'";
			$pub_dezembro= $wpdb->get_results($sql_pub_dezembro,ARRAY_A);
			echo "<td>".$pub_dezembro[0]['SUM(valor)']."</td>";

			$sql_ativ_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '723'";
			$ativ_dezembro = $wpdb->get_results($sql_ativ_dezembro,ARRAY_A);
			echo "<td>".$ativ_dezembro[0]['COUNT(id)']."</td>";

			$sql_age_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_dezembro = $wpdb->get_results($sql_age_dezembro,ARRAY_A);
			echo "<td>".$age_dezembro[0]['COUNT(id)']."</td>";

			$sql_num_age_dezembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '723'";
			$num_age_dezembro = $wpdb->get_results($sql_num_age_dezembro,ARRAY_A);
			echo "<td>".$num_age_dezembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '723'";
			$num_bairros_dezembro = $wpdb->get_results($sql_num_bairros_dezembro,ARRAY_A);
			echo "<td>".$num_bairros_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_dezembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND publicado = '1' AND projeto = '723'";
			$per_bairros_dezembro = $wpdb->get_results($sql_per_bairros_dezembro,ARRAY_A);
			echo "<td>".$per_bairros_dezembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 	periodoInicio BETWEEN '2019-12-01' AND '2019-12-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_dezembro = $wpdb->get_results($sql_num_desc_dezembro,ARRAY_A);
			echo "<td>".$num_desc_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		echo "<tr>";
			...
			$sql_pub_novembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '723'";
			$pub_novembro = $wpdb->get_results($sql_pub_novembro,ARRAY_A);
			echo "<td>".$pub_novembro[0]['SUM(valor)']."</td>";

			$sql_ativ_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '723'";
			$ativ_novembro = $wpdb->get_results($sql_ativ_novembro,ARRAY_A);
			echo "<td>".$ativ_novembro[0]['COUNT(id)']."</td>";

			$sql_age_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_novembro = $wpdb->get_results($sql_age_novembro,ARRAY_A);
			echo "<td>".$age_novembro[0]['COUNT(id)']."</td>";

			$sql_num_age_novembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '723'";
			$num_age_novembro = $wpdb->get_results($sql_num_age_novembro,ARRAY_A);
			echo "<td>".$num_age_novembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_novembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '723'";
			$num_bairros_novembro = $wpdb->get_results($sql_num_bairros_novembro,ARRAY_A);
			echo "<td>".$num_bairros_novembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_novembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND publicado = '1' AND projeto = '723'";
			$per_bairros_novembro = $wpdb->get_results($sql_per_bairros_novembro,ARRAY_A);
			echo "<td>".$per_bairros_novembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_novembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-11-01' AND '2019-11-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_novembro = $wpdb->get_results($sql_num_desc_novembro,ARRAY_A);
			echo "<td>".$num_desc_novembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_outubro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '723'";
			$pub_outubro = $wpdb->get_results($sql_pub_outubro,ARRAY_A);
			echo "<td>".$pub_outubro[0]['SUM(valor)']."</td>";

			$sql_ativ_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '723'";
			$ativ_outubro = $wpdb->get_results($sql_ativ_outubro,ARRAY_A);
			echo "<td>".$ativ_outubro[0]['COUNT(id)']."</td>";

			$sql_age_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_outubro = $wpdb->get_results($sql_age_outubro,ARRAY_A);
			echo "<td>".$age_outubro[0]['COUNT(id)']."</td>";

			$sql_num_age_outubro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '723'";
			$num_age_outubro = $wpdb->get_results($sql_num_age_outubro,ARRAY_A);
			echo "<td>".$num_age_outubro[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '723'";
			$num_bairros_outubro = $wpdb->get_results($sql_num_bairros_outubro,ARRAY_A);
			echo "<td>".$num_bairros_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_outubro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND publicado = '1' AND projeto = '723'";
			$per_bairros_outubro = $wpdb->get_results($sql_per_bairros_outubro,ARRAY_A);
			echo "<td>".$per_bairros_outubro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-10-01' AND '2019-10-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_outubro = $wpdb->get_results($sql_num_desc_outubro,ARRAY_A);
			echo "<td>".$num_desc_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_setembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '723'";
			$pub_setembro = $wpdb->get_results($sql_pub_setembro,ARRAY_A);
			echo "<td>".$pub_setembro[0]['SUM(valor)']."</td>";

			$sql_ativ_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '723'";
			$ativ_setembro = $wpdb->get_results($sql_ativ_setembro,ARRAY_A);
			echo "<td>".$ativ_setembro[0]['COUNT(id)']."</td>";

			$sql_age_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_setembro = $wpdb->get_results($sql_age_setembro,ARRAY_A);
			echo "<td>".$age_setembro[0]['COUNT(id)']."</td>";

			$sql_num_age_setembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '723'";
			$num_age_setembro = $wpdb->get_results($sql_num_age_setembro,ARRAY_A);
			echo "<td>".$num_age_setembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '723'";
			$num_bairros_setembro = $wpdb->get_results($sql_num_bairros_setembro,ARRAY_A);
			echo "<td>".$num_bairros_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_setembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND publicado = '1' AND projeto = '723'";
			$per_bairros_setembro = $wpdb->get_results($sql_per_bairros_setembro,ARRAY_A);
			echo "<td>".$per_bairros_setembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-09-01' AND '2019-09-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_setembro = $wpdb->get_results($sql_num_desc_setembro,ARRAY_A);
			echo "<td>".$num_desc_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_agosto = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '723'";
			$pub_agosto = $wpdb->get_results($sql_pub_agosto,ARRAY_A);
			echo "<td>".$pub_agosto[0]['SUM(valor)']."</td>";

			$sql_ativ_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '723'";
			$ativ_agosto = $wpdb->get_results($sql_ativ_agosto,ARRAY_A);
			echo "<td>".$ativ_agosto[0]['COUNT(id)']."</td>";

			$sql_age_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_agosto = $wpdb->get_results($sql_age_agosto,ARRAY_A);
			echo "<td>".$age_agosto[0]['COUNT(id)']."</td>";

			$sql_num_age_agosto = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '723'";
			$num_age_agosto = $wpdb->get_results($sql_num_age_agosto,ARRAY_A);
			echo "<td>".$num_age_agosto[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '723'";
			$num_bairros_agosto = $wpdb->get_results($sql_num_bairros_agosto,ARRAY_A);
			echo "<td>".$num_bairros_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_agosto = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND publicado = '1' AND projeto = '723'";
			$per_bairros_agosto = $wpdb->get_results($sql_per_bairros_agosto,ARRAY_A);
			echo "<td>".$per_bairros_agosto[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-08-01' AND '2019-08-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_agosto = $wpdb->get_results($sql_num_desc_agosto,ARRAY_A);
			echo "<td>".$num_desc_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			...
			$sql_pub_julho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '723'";
			$pub_julho = $wpdb->get_results($sql_pub_julho,ARRAY_A);
			echo "<td>".$pub_julho[0]['SUM(valor)']."</td>";

			$sql_ativ_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '723'";
			$ativ_julho = $wpdb->get_results($sql_ativ_julho,ARRAY_A);
			echo "<td>".$ativ_julho[0]['COUNT(id)']."</td>";

			$sql_age_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_julho = $wpdb->get_results($sql_age_julho,ARRAY_A);
			echo "<td>".$age_julho[0]['COUNT(id)']."</td>";

			$sql_num_age_julho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '723'";
			$num_age_julho = $wpdb->get_results($sql_num_age_julho,ARRAY_A);
			echo "<td>".$num_age_julho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '723'";
			$num_bairros_julho = $wpdb->get_results($sql_num_bairros_julho,ARRAY_A);
			echo "<td>".$num_bairros_julho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_julho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND publicado = '1' AND projeto = '723'";
			$per_bairros_julho = $wpdb->get_results($sql_per_bairros_julho,ARRAY_A);
			echo "<td>".$per_bairros_julho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-07-01' AND '2019-07-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_julho = $wpdb->get_results($sql_num_desc_julho,ARRAY_A);
			echo "<td>".$num_desc_julho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_junho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '723'";
			$pub_junho = $wpdb->get_results($sql_pub_junho,ARRAY_A);
			echo "<td>".$pub_junho[0]['SUM(valor)']."</td>";

			$sql_ativ_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '723'";
			$ativ_junho = $wpdb->get_results($sql_ativ_junho,ARRAY_A);
			echo "<td>".$ativ_junho[0]['COUNT(id)']."</td>";

			$sql_age_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_junho = $wpdb->get_results($sql_age_junho,ARRAY_A);
			echo "<td>".$age_junho[0]['COUNT(id)']."</td>";

			$sql_num_age_junho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '723'";
			$num_age_junho = $wpdb->get_results($sql_num_age_junho,ARRAY_A);
			echo "<td>".$num_age_junho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '723'";
			$num_bairros_junho = $wpdb->get_results($sql_num_bairros_junho,ARRAY_A);
			echo "<td>".$num_bairros_junho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_junho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND publicado = '1' AND projeto = '723'";
			$per_bairros_junho = $wpdb->get_results($sql_per_bairros_junho,ARRAY_A);
			echo "<td>".$per_bairros_junho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-06-01' AND '2019-06-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_junho = $wpdb->get_results($sql_num_desc_junho,ARRAY_A);
			echo "<td>".$num_desc_junho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_maio = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '723'";
			$pub_maio = $wpdb->get_results($sql_pub_maio,ARRAY_A);
			echo "<td>".$pub_maio[0]['SUM(valor)']."</td>";

		
			$sql_ativ_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '723'";
			$ativ_maio = $wpdb->get_results($sql_ativ_maio,ARRAY_A);
			echo "<td>".$ativ_maio[0]['COUNT(id)']."</td>";

			$sql_age_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_maio = $wpdb->get_results($sql_age_maio,ARRAY_A);
			echo "<td>".$age_maio[0]['COUNT(id)']."</td>";

			$sql_num_age_maio = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '723'";
			$num_age_maio = $wpdb->get_results($sql_num_age_maio,ARRAY_A);
			echo "<td>".$num_age_maio[0]['SUM(quantidade_prof_sa)']."</td>";

		
			$sql_num_bairros_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '723'";
			$num_bairros_maio = $wpdb->get_results($sql_num_bairros_maio,ARRAY_A);
			echo "<td>".$num_bairros_maio[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_maio = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND publicado = '1' AND projeto = '723'";
			$per_bairros_maio = $wpdb->get_results($sql_per_bairros_maio,ARRAY_A);
			echo "<td>".$per_bairros_maio[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-05-01' AND '2019-05-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_maio = $wpdb->get_results($sql_num_desc_maio,ARRAY_A);
			echo "<td>".$num_desc_maio[0]['COUNT(DISTINCT(bairro))']."</td>";	
		...
		echo "<tr>";
			...
			$sql_pub_abril = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '723'";
			$pub_abril = $wpdb->get_results($sql_pub_abril,ARRAY_A);
			echo "<td>".$pub_abril[0]['SUM(valor)']."</td>";

			$sql_ativ_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '723'";
			$ativ_abril = $wpdb->get_results($sql_ativ_abril,ARRAY_A);
			echo "<td>".$ativ_abril[0]['COUNT(id)']."</td>";

			$sql_age_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_abril = $wpdb->get_results($sql_age_abril,ARRAY_A);
			echo "<td>".$age_abril[0]['COUNT(id)']."</td>";

			$sql_num_age_abril = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '723'";
			$num_age_abril = $wpdb->get_results($sql_num_age_abril,ARRAY_A);
			echo "<td>".$num_age_abril[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '723'";
			$num_bairros_abril = $wpdb->get_results($sql_num_bairros_abril,ARRAY_A);
			echo "<td>".$num_bairros_abril[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_abril = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND publicado = '1' AND projeto = '723'";
			$per_bairros_abril = $wpdb->get_results($sql_per_bairros_abril,ARRAY_A);
			echo "<td>".$per_bairros_abril[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 		periodoInicio BETWEEN '2019-04-01' AND '2019-04-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_abril = $wpdb->get_results($sql_num_desc_abril,ARRAY_A);
			echo "<td>".$num_desc_abril[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_marco = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND  projeto = '723'";
			$pub_marco = $wpdb->get_results($sql_pub_marco,ARRAY_A);
			echo "<td>".$pub_marco[0]['SUM(valor)']."</td>";

			$sql_ativ_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND  projeto = '723'";
			$ativ_marco = $wpdb->get_results($sql_ativ_marco,ARRAY_A);
			echo "<td>".$ativ_marco[0]['COUNT(id)']."</td>";

			$sql_age_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND prof_sa = '1' AND  projeto = '723'";
			$age_marco = $wpdb->get_results($sql_age_marco,ARRAY_A);
			echo "<td>".$age_marco[0]['COUNT(id)']."</td>";

			$sql_num_age_marco = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND  projeto = '723'";
			$num_age_marco = $wpdb->get_results($sql_num_age_marco,ARRAY_A);
			echo "<td>".$num_age_marco[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND  projeto = '723'";
			$num_bairros_marco = $wpdb->get_results($sql_num_bairros_marco,ARRAY_A);
			echo "<td>".$num_bairros_marco[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_marco = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND publicado = '1' AND  projeto = '723'";
			$per_bairros_marco = $wpdb->get_results($sql_per_bairros_marco,ARRAY_A);
			echo "<td>".$per_bairros_marco[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-03-01' AND '2019-03-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND  projeto = '723'";
			$num_desc_marco = $wpdb->get_results($sql_num_desc_marco,ARRAY_A);
			echo "<td>".$num_desc_marco[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_fevereiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '723'";
			$pub_fevereiro = $wpdb->get_results($sql_pub_fevereiro,ARRAY_A);
			echo "<td>".$pub_fevereiro[0]['SUM(valor)']."</td>";

			$sql_ativ_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '723'";
			$ativ_fevereiro = $wpdb->get_results($sql_ativ_fevereiro,ARRAY_A);
			echo "<td>".$ativ_fevereiro[0]['COUNT(id)']."</td>";

			$sql_age_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_fevereiro = $wpdb->get_results($sql_age_fevereiro,ARRAY_A);
			echo "<td>".$age_fevereiro[0]['COUNT(id)']."</td>";


			$sql_num_age_fevereiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '723'";
			$num_age_fevereiro = $wpdb->get_results($sql_num_age_fevereiro,ARRAY_A);
			echo "<td>".$num_age_fevereiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '723'";
			$num_bairros_fevereiro = $wpdb->get_results($sql_num_bairros_fevereiro,ARRAY_A);
			echo "<td>".$num_bairros_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_fevereiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND publicado = '1' AND projeto = '723'";
			$per_bairros_fevereiro = $wpdb->get_results($sql_per_bairros_fevereiro,ARRAY_A);
			echo "<td>".$per_bairros_fevereiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-02-01' AND '2019-02-28' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_fevereiro = $wpdb->get_results($sql_num_desc_fevereiro,ARRAY_A);
			echo "<td>".$num_desc_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			echo"<td><strong>JAN</strong></td>";
			$sql_pub_janeiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '723'";
			$pub_janeiro = $wpdb->get_results($sql_pub_janeiro,ARRAY_A);
			echo "<td>".$pub_janeiro[0]['SUM(valor)']."</td>";

			$sql_ativ_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '723'";
			$ativ_janeiro = $wpdb->get_results($sql_ativ_janeiro,ARRAY_A);
			echo "<td>".$ativ_janeiro[0]['COUNT(id)']."</td>";

			$sql_age_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_janeiro = $wpdb->get_results($sql_age_janeiro,ARRAY_A);
			echo "<td>".$age_janeiro[0]['COUNT(id)']."</td>";

			$sql_num_age_janeiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '723'";
			$num_age_janeiro = $wpdb->get_results($sql_num_age_janeiro,ARRAY_A);
			echo "<td>".$num_age_janeiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '723'";
			$num_bairros_janeiro = $wpdb->get_results($sql_num_bairros_janeiro,ARRAY_A);
			echo "<td>".$num_bairros_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_janeiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND publicado = '1' AND projeto = '723'";
			$per_bairros_janeiro = $wpdb->get_results($sql_per_bairros_janeiro,ARRAY_A);
			echo "<td>".$per_bairros_janeiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2019-01-01' AND '2019-01-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_janeiro = $wpdb->get_results($sql_num_desc_janeiro,ARRAY_A);
			echo "<td>".$num_desc_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_total = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '723'";
			$pub_total= $wpdb->get_results($sql_pub_total,ARRAY_A);
			echo "<td>".$pub_total[0]['SUM(valor)']."</td>";

			$sql_ativ_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '723'";
			$ativ_total = $wpdb->get_results($sql_ativ_total,ARRAY_A);
			echo "<td>".$ativ_total[0]['COUNT(id)']."</td>";

			$sql_age_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND prof_sa = '1' AND projeto = '723'";
			$age_total = $wpdb->get_results($sql_age_total,ARRAY_A);
			echo "<td>".$age_total[0]['COUNT(id)']."</td>";

			$sql_num_age_total = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '723'";
			$num_age_total = $wpdb->get_results($sql_num_age_total,ARRAY_A);
			echo "<td>".$num_age_total[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '723'";
			$num_bairros_total = $wpdb->get_results($sql_num_bairros_total,ARRAY_A);
			echo "<td>".$num_bairros_total[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_total = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND publicado = '1' AND projeto = '723'";
			$per_bairros_total = $wpdb->get_results($sql_per_bairros_total,ARRAY_A);
			echo "<td>".$per_bairros_total[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2019%' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '723'";
			$num_desc_total = $wpdb->get_results($sql_num_desc_total,ARRAY_A);
			echo "<td>".$num_desc_total[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		<table class="table table-striped">
			<thead>	
				...
				<tr>
					...
					<th>Nº Agentes Culturais Locais Envolvidos</th>
					<th>Nº Bairros</th>
					<th>% Bairros da Cidade Atendidos (Ref. 105 bairros)</th>
					<th>Nº Bairros Descentralizados</th>
					<th width="10%"></th>
					<th width="10%"></th>
				</tr>
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_per_bairros_dezembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1'";
			$per_bairros_dezembro = $wpdb->get_results($sql_per_bairros_dezembro,ARRAY_A);
			echo "<td>".$per_bairros_dezembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_novembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1'";
			$per_bairros_novembro = $wpdb->get_results($sql_per_bairros_novembro,ARRAY_A);
			echo "<td>".$per_bairros_novembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_outubro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1'";
			$per_bairros_outubro = $wpdb->get_results($sql_per_bairros_outubro,ARRAY_A);
			echo "<td>".$per_bairros_outubro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_setembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1'";
			$per_bairros_setembro = $wpdb->get_results($sql_per_bairros_setembro,ARRAY_A);
			echo "<td>".$per_bairros_setembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_agosto = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1'";
			$per_bairros_agosto = $wpdb->get_results($sql_per_bairros_agosto,ARRAY_A);
			echo "<td>".$per_bairros_agosto[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_julho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1'";
			$per_bairros_julho = $wpdb->get_results($sql_per_bairros_julho,ARRAY_A);
			echo "<td>".$per_bairros_julho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_junho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1'";
			$per_bairros_junho = $wpdb->get_results($sql_per_bairros_junho,ARRAY_A);
			echo "<td>".$per_bairros_junho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_maio = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1'";
			$per_bairros_maio = $wpdb->get_results($sql_per_bairros_maio,ARRAY_A);
			echo "<td>".$per_bairros_maio[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_abril = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1'";
			$per_bairros_abril = $wpdb->get_results($sql_per_bairros_abril,ARRAY_A);
			echo "<td>".$per_bairros_abril[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_marco = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1'";
			$per_bairros_marco = $wpdb->get_results($sql_per_bairros_marco,ARRAY_A);
			echo "<td>".$per_bairros_marco[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_fevereiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1'";
			$per_bairros_fevereiro = $wpdb->get_results($sql_per_bairros_fevereiro,ARRAY_A);
			echo "<td>".$per_bairros_fevereiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_janeiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1'";
			$per_bairros_janeiro = $wpdb->get_results($sql_per_bairros_janeiro,ARRAY_A);
			echo "<td>".$per_bairros_janeiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		echo "<tr>";
			...
			$sql_per_bairros_total = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1'";
			$per_bairros_total = $wpdb->get_results($sql_per_bairros_total,ARRAY_A);
			echo "<td>".$per_bairros_total[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
		...
		<table class="table table-striped">
			<thead>
				<label><h2>2018 - Orquestra</h2></label>
				<tr>
					<th>Período</th>
					<th>Público</th>
					<th>Nº Atividades</th>
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_pub_dezembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '349'";
			$pub_dezembro= $wpdb->get_results($sql_pub_dezembro,ARRAY_A);
			echo "<td>".$pub_dezembro[0]['SUM(valor)']."</td>";

			$sql_ativ_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '349'";
			$ativ_dezembro = $wpdb->get_results($sql_ativ_dezembro,ARRAY_A);
			echo "<td>".$ativ_dezembro[0]['COUNT(id)']."</td>";

			$sql_age_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_dezembro = $wpdb->get_results($sql_age_dezembro,ARRAY_A);
			echo "<td>".$age_dezembro[0]['COUNT(id)']."</td>";

			$sql_num_age_dezembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '349'";
			$num_age_dezembro = $wpdb->get_results($sql_num_age_dezembro,ARRAY_A);
			echo "<td>".$num_age_dezembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '349'";
			$num_bairros_dezembro = $wpdb->get_results($sql_num_bairros_dezembro,ARRAY_A);
			echo "<td>".$num_bairros_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_dezembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '349'";
			$per_bairros_dezembro = $wpdb->get_results($sql_per_bairros_dezembro,ARRAY_A);
			echo "<td>".$per_bairros_dezembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 	periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_dezembro = $wpdb->get_results($sql_num_desc_dezembro,ARRAY_A);
			echo "<td>".$num_desc_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		echo "<tr>";
			...
			$sql_pub_novembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '349'";
			$pub_novembro = $wpdb->get_results($sql_pub_novembro,ARRAY_A);
			echo "<td>".$pub_novembro[0]['SUM(valor)']."</td>";

			$sql_ativ_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '349'";
			$ativ_novembro = $wpdb->get_results($sql_ativ_novembro,ARRAY_A);
			echo "<td>".$ativ_novembro[0]['COUNT(id)']."</td>";

			$sql_age_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_novembro = $wpdb->get_results($sql_age_novembro,ARRAY_A);
			echo "<td>".$age_novembro[0]['COUNT(id)']."</td>";

			$sql_num_age_novembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '349'";
			$num_age_novembro = $wpdb->get_results($sql_num_age_novembro,ARRAY_A);
			echo "<td>".$num_age_novembro[0]['SUM(quantidade_prof_sa)']."</td>";
			...
			$sql_per_bairros_novembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '349'";
			$per_bairros_novembro = $wpdb->get_results($sql_per_bairros_novembro,ARRAY_A);
			echo "<td>".$per_bairros_novembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_novembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_novembro = $wpdb->get_results($sql_num_desc_novembro,ARRAY_A);
			echo "<td>".$num_desc_novembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_outubro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '349'";
			$pub_outubro = $wpdb->get_results($sql_pub_outubro,ARRAY_A);
			echo "<td>".$pub_outubro[0]['SUM(valor)']."</td>";

			$sql_ativ_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '349'";
			$ativ_outubro = $wpdb->get_results($sql_ativ_outubro,ARRAY_A);
			echo "<td>".$ativ_outubro[0]['COUNT(id)']."</td>";

			$sql_age_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_outubro = $wpdb->get_results($sql_age_outubro,ARRAY_A);
			echo "<td>".$age_outubro[0]['COUNT(id)']."</td>";

			$sql_num_age_outubro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '349'";
			$num_age_outubro = $wpdb->get_results($sql_num_age_outubro,ARRAY_A);
			echo "<td>".$num_age_outubro[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '349'";
			$num_bairros_outubro = $wpdb->get_results($sql_num_bairros_outubro,ARRAY_A);
			echo "<td>".$num_bairros_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_outubro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '349'";
			$per_bairros_outubro = $wpdb->get_results($sql_per_bairros_outubro,ARRAY_A);
			echo "<td>".$per_bairros_outubro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_outubro = $wpdb->get_results($sql_num_desc_outubro,ARRAY_A);
			echo "<td>".$num_desc_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_setembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '349'";
			$pub_setembro = $wpdb->get_results($sql_pub_setembro,ARRAY_A);
			echo "<td>".$pub_setembro[0]['SUM(valor)']."</td>";

			$sql_ativ_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '349'";
			$ativ_setembro = $wpdb->get_results($sql_ativ_setembro,ARRAY_A);
			echo "<td>".$ativ_setembro[0]['COUNT(id)']."</td>";

			$sql_age_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_setembro = $wpdb->get_results($sql_age_setembro,ARRAY_A);
			echo "<td>".$age_setembro[0]['COUNT(id)']."</td>";

			$sql_num_age_setembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '349'";
			$num_age_setembro = $wpdb->get_results($sql_num_age_setembro,ARRAY_A);
			echo "<td>".$num_age_setembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '349'";
			$num_bairros_setembro = $wpdb->get_results($sql_num_bairros_setembro,ARRAY_A);
			echo "<td>".$num_bairros_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_setembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '349'";
			$per_bairros_setembro = $wpdb->get_results($sql_per_bairros_setembro,ARRAY_A);
			echo "<td>".$per_bairros_setembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_setembro = $wpdb->get_results($sql_num_desc_setembro,ARRAY_A);
			echo "<td>".$num_desc_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_agosto = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '349'";
			$pub_agosto = $wpdb->get_results($sql_pub_agosto,ARRAY_A);
			echo "<td>".$pub_agosto[0]['SUM(valor)']."</td>";

			$sql_ativ_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '349'";
			$ativ_agosto = $wpdb->get_results($sql_ativ_agosto,ARRAY_A);
			echo "<td>".$ativ_agosto[0]['COUNT(id)']."</td>";

			$sql_age_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_agosto = $wpdb->get_results($sql_age_agosto,ARRAY_A);
			echo "<td>".$age_agosto[0]['COUNT(id)']."</td>";

			$sql_num_age_agosto = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '349'";
			$num_age_agosto = $wpdb->get_results($sql_num_age_agosto,ARRAY_A);
			echo "<td>".$num_age_agosto[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '349'";
			$num_bairros_agosto = $wpdb->get_results($sql_num_bairros_agosto,ARRAY_A);
			echo "<td>".$num_bairros_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_agosto = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '349'";
			$per_bairros_agosto = $wpdb->get_results($sql_per_bairros_agosto,ARRAY_A);
			echo "<td>".$per_bairros_agosto[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_agosto = $wpdb->get_results($sql_num_desc_agosto,ARRAY_A);
			echo "<td>".$num_desc_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			...
			$sql_pub_julho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '349'";
			$pub_julho = $wpdb->get_results($sql_pub_julho,ARRAY_A);
			echo "<td>".$pub_julho[0]['SUM(valor)']."</td>";

			$sql_ativ_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '349'";
			$ativ_julho = $wpdb->get_results($sql_ativ_julho,ARRAY_A);
			echo "<td>".$ativ_julho[0]['COUNT(id)']."</td>";

			$sql_age_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_julho = $wpdb->get_results($sql_age_julho,ARRAY_A);
			echo "<td>".$age_julho[0]['COUNT(id)']."</td>";

			$sql_num_age_julho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '349'";
			$num_age_julho = $wpdb->get_results($sql_num_age_julho,ARRAY_A);
			echo "<td>".$num_age_julho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '349'";
			$num_bairros_julho = $wpdb->get_results($sql_num_bairros_julho,ARRAY_A);
			echo "<td>".$num_bairros_julho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_julho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '349'";
			$per_bairros_julho = $wpdb->get_results($sql_per_bairros_julho,ARRAY_A);
			echo "<td>".$per_bairros_julho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_julho = $wpdb->get_results($sql_num_desc_julho,ARRAY_A);
			echo "<td>".$num_desc_julho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_junho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '349'";
			$pub_junho = $wpdb->get_results($sql_pub_junho,ARRAY_A);
			echo "<td>".$pub_junho[0]['SUM(valor)']."</td>";

			$sql_ativ_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '349'";
			$ativ_junho = $wpdb->get_results($sql_ativ_junho,ARRAY_A);
			echo "<td>".$ativ_junho[0]['COUNT(id)']."</td>";

			$sql_age_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_junho = $wpdb->get_results($sql_age_junho,ARRAY_A);
			echo "<td>".$age_junho[0]['COUNT(id)']."</td>";

			$sql_num_age_junho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '349'";
			$num_age_junho = $wpdb->get_results($sql_num_age_junho,ARRAY_A);
			echo "<td>".$num_age_junho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '349'";
			$num_bairros_junho = $wpdb->get_results($sql_num_bairros_junho,ARRAY_A);
			echo "<td>".$num_bairros_junho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_junho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '349'";
			$per_bairros_junho = $wpdb->get_results($sql_per_bairros_junho,ARRAY_A);
			echo "<td>".$per_bairros_junho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_junho = $wpdb->get_results($sql_num_desc_junho,ARRAY_A);
			echo "<td>".$num_desc_junho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_maio = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '349'";
			$pub_maio = $wpdb->get_results($sql_pub_maio,ARRAY_A);
			echo "<td>".$pub_maio[0]['SUM(valor)']."</td>";

		
			$sql_ativ_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '349'";
			$ativ_maio = $wpdb->get_results($sql_ativ_maio,ARRAY_A);
			echo "<td>".$ativ_maio[0]['COUNT(id)']."</td>";

			$sql_age_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_maio = $wpdb->get_results($sql_age_maio,ARRAY_A);
			echo "<td>".$age_maio[0]['COUNT(id)']."</td>";

			$sql_num_age_maio = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '349'";
			$num_age_maio = $wpdb->get_results($sql_num_age_maio,ARRAY_A);
			echo "<td>".$num_age_maio[0]['SUM(quantidade_prof_sa)']."</td>";

		
			$sql_num_bairros_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '349'";
			$num_bairros_maio = $wpdb->get_results($sql_num_bairros_maio,ARRAY_A);
			echo "<td>".$num_bairros_maio[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_maio = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '349'";
			$per_bairros_maio = $wpdb->get_results($sql_per_bairros_maio,ARRAY_A);
			echo "<td>".$per_bairros_maio[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_maio = $wpdb->get_results($sql_num_desc_maio,ARRAY_A);
			echo "<td>".$num_desc_maio[0]['COUNT(DISTINCT(bairro))']."</td>";	
		...
		echo "<tr>";
			...
			$sql_pub_abril = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '349'";
			$pub_abril = $wpdb->get_results($sql_pub_abril,ARRAY_A);
			echo "<td>".$pub_abril[0]['SUM(valor)']."</td>";

			$sql_ativ_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '349'";
			$ativ_abril = $wpdb->get_results($sql_ativ_abril,ARRAY_A);
			echo "<td>".$ativ_abril[0]['COUNT(id)']."</td>";

			$sql_age_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_abril = $wpdb->get_results($sql_age_abril,ARRAY_A);
			echo "<td>".$age_abril[0]['COUNT(id)']."</td>";

			$sql_num_age_abril = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '349'";
			$num_age_abril = $wpdb->get_results($sql_num_age_abril,ARRAY_A);
			echo "<td>".$num_age_abril[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '349'";
			$num_bairros_abril = $wpdb->get_results($sql_num_bairros_abril,ARRAY_A);
			echo "<td>".$num_bairros_abril[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_abril = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '349'";
			$per_bairros_abril = $wpdb->get_results($sql_per_bairros_abril,ARRAY_A);
			echo "<td>".$per_bairros_abril[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 		periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_abril = $wpdb->get_results($sql_num_desc_abril,ARRAY_A);
			echo "<td>".$num_desc_abril[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_marco = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND projeto = '349'";
			$pub_marco = $wpdb->get_results($sql_pub_marco,ARRAY_A);
			echo "<td>".$pub_marco[0]['SUM(valor)']."</td>";

			$sql_ativ_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND projeto = '349'";
			$ativ_marco = $wpdb->get_results($sql_ativ_marco,ARRAY_A);
			echo "<td>".$ativ_marco[0]['COUNT(id)']."</td>";

			$sql_age_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_marco = $wpdb->get_results($sql_age_marco,ARRAY_A);
			echo "<td>".$age_marco[0]['COUNT(id)']."</td>";

			$sql_num_age_marco = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND projeto = '349'";
			$num_age_marco = $wpdb->get_results($sql_num_age_marco,ARRAY_A);
			echo "<td>".$num_age_marco[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND projeto = '349'";
			$num_bairros_marco = $wpdb->get_results($sql_num_bairros_marco,ARRAY_A);
			echo "<td>".$num_bairros_marco[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_marco = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND projeto = '349'";
			$per_bairros_marco = $wpdb->get_results($sql_per_bairros_marco,ARRAY_A);
			echo "<td>".$per_bairros_marco[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_marco = $wpdb->get_results($sql_num_desc_marco,ARRAY_A);
			echo "<td>".$num_desc_marco[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_fevereiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '349'";
			$pub_fevereiro = $wpdb->get_results($sql_pub_fevereiro,ARRAY_A);
			echo "<td>".$pub_fevereiro[0]['SUM(valor)']."</td>";

			$sql_ativ_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '349'";
			$ativ_fevereiro = $wpdb->get_results($sql_ativ_fevereiro,ARRAY_A);
			echo "<td>".$ativ_fevereiro[0]['COUNT(id)']."</td>";

			$sql_age_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_fevereiro = $wpdb->get_results($sql_age_fevereiro,ARRAY_A);
			echo "<td>".$age_fevereiro[0]['COUNT(id)']."</td>";


			$sql_num_age_fevereiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '349'";
			$num_age_fevereiro = $wpdb->get_results($sql_num_age_fevereiro,ARRAY_A);
			echo "<td>".$num_age_fevereiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '349'";
			$num_bairros_fevereiro = $wpdb->get_results($sql_num_bairros_fevereiro,ARRAY_A);
			echo "<td>".$num_bairros_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_fevereiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '349'";
			$per_bairros_fevereiro = $wpdb->get_results($sql_per_bairros_fevereiro,ARRAY_A);
			echo "<td>".$per_bairros_fevereiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_fevereiro = $wpdb->get_results($sql_num_desc_fevereiro,ARRAY_A);
			echo "<td>".$num_desc_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			echo"<td><strong>JAN</strong></td>";
			$sql_pub_janeiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '349'";
			$pub_janeiro = $wpdb->get_results($sql_pub_janeiro,ARRAY_A);
			echo "<td>".$pub_janeiro[0]['SUM(valor)']."</td>";

			$sql_ativ_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '349'";
			$ativ_janeiro = $wpdb->get_results($sql_ativ_janeiro,ARRAY_A);
			echo "<td>".$ativ_janeiro[0]['COUNT(id)']."</td>";

			$sql_age_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_janeiro = $wpdb->get_results($sql_age_janeiro,ARRAY_A);
			echo "<td>".$age_janeiro[0]['COUNT(id)']."</td>";

			$sql_num_age_janeiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '349'";
			$num_age_janeiro = $wpdb->get_results($sql_num_age_janeiro,ARRAY_A);
			echo "<td>".$num_age_janeiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '349'";
			$num_bairros_janeiro = $wpdb->get_results($sql_num_bairros_janeiro,ARRAY_A);
			echo "<td>".$num_bairros_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_janeiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '349'";
			$per_bairros_janeiro = $wpdb->get_results($sql_per_bairros_janeiro,ARRAY_A);
			echo "<td>".$per_bairros_janeiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_janeiro = $wpdb->get_results($sql_num_desc_janeiro,ARRAY_A);
			echo "<td>".$num_desc_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_total = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '349'";
			$pub_total= $wpdb->get_results($sql_pub_total,ARRAY_A);
			echo "<td>".$pub_total[0]['SUM(valor)']."</td>";

			$sql_ativ_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '349'";
			$ativ_total = $wpdb->get_results($sql_ativ_total,ARRAY_A);
			echo "<td>".$ativ_total[0]['COUNT(id)']."</td>";

			$sql_age_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND prof_sa = '1' AND projeto = '349'";
			$age_total = $wpdb->get_results($sql_age_total,ARRAY_A);
			echo "<td>".$age_total[0]['COUNT(id)']."</td>";

			$sql_num_age_total = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '349'";
			$num_age_total = $wpdb->get_results($sql_num_age_total,ARRAY_A);
			echo "<td>".$num_age_total[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '349'";
			$num_bairros_total = $wpdb->get_results($sql_num_bairros_total,ARRAY_A);
			echo "<td>".$num_bairros_total[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_total = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '349'";
			$per_bairros_total = $wpdb->get_results($sql_per_bairros_total,ARRAY_A);
			echo "<td>".$per_bairros_total[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '349'";
			$num_desc_total = $wpdb->get_results($sql_num_desc_total,ARRAY_A);
			echo "<td>".$num_desc_total[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_pub_dezembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '273'";
			$pub_dezembro= $wpdb->get_results($sql_pub_dezembro,ARRAY_A);
			echo "<td>".$pub_dezembro[0]['SUM(valor)']."</td>";

			$sql_ativ_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '378'";
			$ativ_dezembro = $wpdb->get_results($sql_ativ_dezembro,ARRAY_A);
			echo "<td>".$ativ_dezembro[0]['COUNT(id)']."</td>";

			$sql_age_dezembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_dezembro = $wpdb->get_results($sql_age_dezembro,ARRAY_A);
			echo "<td>".$age_dezembro[0]['COUNT(id)']."</td>";

			$sql_num_age_dezembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '378'";
			$num_age_dezembro = $wpdb->get_results($sql_num_age_dezembro,ARRAY_A);
			echo "<td>".$num_age_dezembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '378'";
			$num_bairros_dezembro = $wpdb->get_results($sql_num_bairros_dezembro,ARRAY_A);
			echo "<td>".$num_bairros_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_dezembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND publicado = '1' AND projeto = '378'";
			$per_bairros_dezembro = $wpdb->get_results($sql_per_bairros_dezembro,ARRAY_A);
			echo "<td>".$per_bairros_dezembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_dezembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 	periodoInicio BETWEEN '2018-12-01' AND '2018-12-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_dezembro = $wpdb->get_results($sql_num_desc_dezembro,ARRAY_A);
			echo "<td>".$num_desc_dezembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		echo "<tr>";
			...
			$sql_pub_novembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '378'";
			$pub_novembro = $wpdb->get_results($sql_pub_novembro,ARRAY_A);
			echo "<td>".$pub_novembro[0]['SUM(valor)']."</td>";

			$sql_ativ_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '378'";
			$ativ_novembro = $wpdb->get_results($sql_ativ_novembro,ARRAY_A);
			echo "<td>".$ativ_novembro[0]['COUNT(id)']."</td>";

			$sql_age_novembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_novembro = $wpdb->get_results($sql_age_novembro,ARRAY_A);
			echo "<td>".$age_novembro[0]['COUNT(id)']."</td>";

			$sql_num_age_novembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '378'";
			$num_age_novembro = $wpdb->get_results($sql_num_age_novembro,ARRAY_A);
			echo "<td>".$num_age_novembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_novembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '378'";
			$num_bairros_novembro = $wpdb->get_results($sql_num_bairros_novembro,ARRAY_A);
			echo "<td>".$num_bairros_novembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_novembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND publicado = '1' AND projeto = '378'";
			$per_bairros_novembro = $wpdb->get_results($sql_per_bairros_novembro,ARRAY_A);
			echo "<td>".$per_bairros_novembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_novembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-11-01' AND '2018-11-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_novembro = $wpdb->get_results($sql_num_desc_novembro,ARRAY_A);
			echo "<td>".$num_desc_novembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_outubro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '378'";
			$pub_outubro = $wpdb->get_results($sql_pub_outubro,ARRAY_A);
			echo "<td>".$pub_outubro[0]['SUM(valor)']."</td>";

			$sql_ativ_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '378'";
			$ativ_outubro = $wpdb->get_results($sql_ativ_outubro,ARRAY_A);
			echo "<td>".$ativ_outubro[0]['COUNT(id)']."</td>";

			$sql_age_outubro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_outubro = $wpdb->get_results($sql_age_outubro,ARRAY_A);
			echo "<td>".$age_outubro[0]['COUNT(id)']."</td>";

			$sql_num_age_outubro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '378'";
			$num_age_outubro = $wpdb->get_results($sql_num_age_outubro,ARRAY_A);
			echo "<td>".$num_age_outubro[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '378'";
			$num_bairros_outubro = $wpdb->get_results($sql_num_bairros_outubro,ARRAY_A);
			echo "<td>".$num_bairros_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_outubro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND publicado = '1' AND projeto = '378'";
			$per_bairros_outubro = $wpdb->get_results($sql_per_bairros_outubro,ARRAY_A);
			echo "<td>".$per_bairros_outubro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_outubro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-10-01' AND '2018-10-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_outubro = $wpdb->get_results($sql_num_desc_outubro,ARRAY_A);
			echo "<td>".$num_desc_outubro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_setembro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '378'";
			$pub_setembro = $wpdb->get_results($sql_pub_setembro,ARRAY_A);
			echo "<td>".$pub_setembro[0]['SUM(valor)']."</td>";

			$sql_ativ_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '378'";
			$ativ_setembro = $wpdb->get_results($sql_ativ_setembro,ARRAY_A);
			echo "<td>".$ativ_setembro[0]['COUNT(id)']."</td>";

			$sql_age_setembro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_setembro = $wpdb->get_results($sql_age_setembro,ARRAY_A);
			echo "<td>".$age_setembro[0]['COUNT(id)']."</td>";

			$sql_num_age_setembro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '378'";
			$num_age_setembro = $wpdb->get_results($sql_num_age_setembro,ARRAY_A);
			echo "<td>".$num_age_setembro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '378'";
			$num_bairros_setembro = $wpdb->get_results($sql_num_bairros_setembro,ARRAY_A);
			echo "<td>".$num_bairros_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_setembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND publicado = '1' AND projeto = '378'";
			$per_bairros_setembro = $wpdb->get_results($sql_per_bairros_setembro,ARRAY_A);
			echo "<td>".$per_bairros_setembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_setembro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-09-01' AND '2018-09-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_setembro = $wpdb->get_results($sql_num_desc_setembro,ARRAY_A);
			echo "<td>".$num_desc_setembro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_agosto = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '378'";
			$pub_agosto = $wpdb->get_results($sql_pub_agosto,ARRAY_A);
			echo "<td>".$pub_agosto[0]['SUM(valor)']."</td>";

			$sql_ativ_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '378'";
			$ativ_agosto = $wpdb->get_results($sql_ativ_agosto,ARRAY_A);
			echo "<td>".$ativ_agosto[0]['COUNT(id)']."</td>";

			$sql_age_agosto = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_agosto = $wpdb->get_results($sql_age_agosto,ARRAY_A);
			echo "<td>".$age_agosto[0]['COUNT(id)']."</td>";

			$sql_num_age_agosto = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '378'";
			$num_age_agosto = $wpdb->get_results($sql_num_age_agosto,ARRAY_A);
			echo "<td>".$num_age_agosto[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '378'";
			$num_bairros_agosto = $wpdb->get_results($sql_num_bairros_agosto,ARRAY_A);
			echo "<td>".$num_bairros_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_agosto = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND publicado = '1' AND projeto = '378'";
			$per_bairros_agosto = $wpdb->get_results($sql_per_bairros_agosto,ARRAY_A);
			echo "<td>".$per_bairros_agosto[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_agosto = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-08-01' AND '2018-08-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_agosto = $wpdb->get_results($sql_num_desc_agosto,ARRAY_A);
			echo "<td>".$num_desc_agosto[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			...
			$sql_pub_julho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '378'";
			$pub_julho = $wpdb->get_results($sql_pub_julho,ARRAY_A);
			echo "<td>".$pub_julho[0]['SUM(valor)']."</td>";

			$sql_ativ_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '378'";
			$ativ_julho = $wpdb->get_results($sql_ativ_julho,ARRAY_A);
			echo "<td>".$ativ_julho[0]['COUNT(id)']."</td>";

			$sql_age_julho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_julho = $wpdb->get_results($sql_age_julho,ARRAY_A);
			echo "<td>".$age_julho[0]['COUNT(id)']."</td>";

			$sql_num_age_julho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '378'";
			$num_age_julho = $wpdb->get_results($sql_num_age_julho,ARRAY_A);
			echo "<td>".$num_age_julho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '378'";
			$num_bairros_julho = $wpdb->get_results($sql_num_bairros_julho,ARRAY_A);
			echo "<td>".$num_bairros_julho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_julho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND publicado = '1' AND projeto = '378'";
			$per_bairros_julho = $wpdb->get_results($sql_per_bairros_julho,ARRAY_A);
			echo "<td>".$per_bairros_julho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_julho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-07-01' AND '2018-07-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_julho = $wpdb->get_results($sql_num_desc_julho,ARRAY_A);
			echo "<td>".$num_desc_julho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_junho = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '378'";
			$pub_junho = $wpdb->get_results($sql_pub_junho,ARRAY_A);
			echo "<td>".$pub_junho[0]['SUM(valor)']."</td>";

			$sql_ativ_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '378'";
			$ativ_junho = $wpdb->get_results($sql_ativ_junho,ARRAY_A);
			echo "<td>".$ativ_junho[0]['COUNT(id)']."</td>";

			$sql_age_junho = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_junho = $wpdb->get_results($sql_age_junho,ARRAY_A);
			echo "<td>".$age_junho[0]['COUNT(id)']."</td>";

			$sql_num_age_junho = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '378'";
			$num_age_junho = $wpdb->get_results($sql_num_age_junho,ARRAY_A);
			echo "<td>".$num_age_junho[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '378'";
			$num_bairros_junho = $wpdb->get_results($sql_num_bairros_junho,ARRAY_A);
			echo "<td>".$num_bairros_junho[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_junho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND publicado = '1' AND projeto = '378'";
			$per_bairros_junho = $wpdb->get_results($sql_per_bairros_junho,ARRAY_A);
			echo "<td>".$per_bairros_junho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_junho = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-06-01' AND '2018-06-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_junho = $wpdb->get_results($sql_num_desc_junho,ARRAY_A);
			echo "<td>".$num_desc_junho[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_maio = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '378'";
			$pub_maio = $wpdb->get_results($sql_pub_maio,ARRAY_A);
			echo "<td>".$pub_maio[0]['SUM(valor)']."</td>";

		
			$sql_ativ_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '378'";
			$ativ_maio = $wpdb->get_results($sql_ativ_maio,ARRAY_A);
			echo "<td>".$ativ_maio[0]['COUNT(id)']."</td>";

			$sql_age_maio = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_maio = $wpdb->get_results($sql_age_maio,ARRAY_A);
			echo "<td>".$age_maio[0]['COUNT(id)']."</td>";

			$sql_num_age_maio = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '378'";
			$num_age_maio = $wpdb->get_results($sql_num_age_maio,ARRAY_A);
			echo "<td>".$num_age_maio[0]['SUM(quantidade_prof_sa)']."</td>";

		
			$sql_num_bairros_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '378'";
			$num_bairros_maio = $wpdb->get_results($sql_num_bairros_maio,ARRAY_A);
			echo "<td>".$num_bairros_maio[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_maio = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND publicado = '1' AND projeto = '378'";
			$per_bairros_maio = $wpdb->get_results($sql_per_bairros_maio,ARRAY_A);
			echo "<td>".$per_bairros_maio[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";


			$sql_num_desc_maio = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-05-01' AND '2018-05-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_maio = $wpdb->get_results($sql_num_desc_maio,ARRAY_A);
			echo "<td>".$num_desc_maio[0]['COUNT(DISTINCT(bairro))']."</td>";	
		...
		echo "<tr>";
			...
			$sql_pub_abril = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '378'";
			$pub_abril = $wpdb->get_results($sql_pub_abril,ARRAY_A);
			echo "<td>".$pub_abril[0]['SUM(valor)']."</td>";

			$sql_ativ_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '378'";
			$ativ_abril = $wpdb->get_results($sql_ativ_abril,ARRAY_A);
			echo "<td>".$ativ_abril[0]['COUNT(id)']."</td>";

			$sql_age_abril = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_abril = $wpdb->get_results($sql_age_abril,ARRAY_A);
			echo "<td>".$age_abril[0]['COUNT(id)']."</td>";

			$sql_num_age_abril = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '378'";
			$num_age_abril = $wpdb->get_results($sql_num_age_abril,ARRAY_A);
			echo "<td>".$num_age_abril[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '378'";
			$num_bairros_abril = $wpdb->get_results($sql_num_bairros_abril,ARRAY_A);
			echo "<td>".$num_bairros_abril[0]['COUNT(DISTINCT(bairro))']."</td>";


			$sql_per_bairros_abril = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND publicado = '1' AND projeto = '378'";
			$per_bairros_abril = $wpdb->get_results($sql_per_bairros_abril,ARRAY_A);
			echo "<td>".$per_bairros_abril[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_abril = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE 		periodoInicio BETWEEN '2018-04-01' AND '2018-04-30' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_abril = $wpdb->get_results($sql_num_desc_abril,ARRAY_A);
			echo "<td>".$num_desc_abril[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_marco = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND  projeto = '378'";
			$pub_marco = $wpdb->get_results($sql_pub_marco,ARRAY_A);
			echo "<td>".$pub_marco[0]['SUM(valor)']."</td>";

			$sql_ativ_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND  projeto = '378'";
			$ativ_marco = $wpdb->get_results($sql_ativ_marco,ARRAY_A);
			echo "<td>".$ativ_marco[0]['COUNT(id)']."</td>";

			$sql_age_marco = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND prof_sa = '1' AND  projeto = '378'";
			$age_marco = $wpdb->get_results($sql_age_marco,ARRAY_A);
			echo "<td>".$age_marco[0]['COUNT(id)']."</td>";

			$sql_num_age_marco = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND  projeto = '378'";
			$num_age_marco = $wpdb->get_results($sql_num_age_marco,ARRAY_A);
			echo "<td>".$num_age_marco[0]['SUM(quantidade_prof_sa)']."</td>";


			$sql_num_bairros_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND  projeto = '378'";
			$num_bairros_marco = $wpdb->get_results($sql_num_bairros_marco,ARRAY_A);
			echo "<td>".$num_bairros_marco[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_marco = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND publicado = '1' AND  projeto = '378'";
			$per_bairros_marco = $wpdb->get_results($sql_per_bairros_marco,ARRAY_A);
			echo "<td>".$per_bairros_marco[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_marco = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-03-01' AND '2018-03-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND  projeto = '378'";
			$num_desc_marco = $wpdb->get_results($sql_num_desc_marco,ARRAY_A);
			echo "<td>".$num_desc_marco[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			...
			$sql_pub_fevereiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '378'";
			$pub_fevereiro = $wpdb->get_results($sql_pub_fevereiro,ARRAY_A);
			echo "<td>".$pub_fevereiro[0]['SUM(valor)']."</td>";

			$sql_ativ_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '378'";
			$ativ_fevereiro = $wpdb->get_results($sql_ativ_fevereiro,ARRAY_A);
			echo "<td>".$ativ_fevereiro[0]['COUNT(id)']."</td>";

			$sql_age_fevereiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_fevereiro = $wpdb->get_results($sql_age_fevereiro,ARRAY_A);
			echo "<td>".$age_fevereiro[0]['COUNT(id)']."</td>";


			$sql_num_age_fevereiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '378'";
			$num_age_fevereiro = $wpdb->get_results($sql_num_age_fevereiro,ARRAY_A);
			echo "<td>".$num_age_fevereiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '378'";
			$num_bairros_fevereiro = $wpdb->get_results($sql_num_bairros_fevereiro,ARRAY_A);
			echo "<td>".$num_bairros_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_fevereiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND publicado = '1' AND projeto = '378'";
			$per_bairros_fevereiro = $wpdb->get_results($sql_per_bairros_fevereiro,ARRAY_A);
			echo "<td>".$per_bairros_fevereiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_fevereiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-02-01' AND '2018-02-28' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_fevereiro = $wpdb->get_results($sql_num_desc_fevereiro,ARRAY_A);
			echo "<td>".$num_desc_fevereiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		...
		echo "<tr>";
			echo"<td><strong>JAN</strong></td>";
			$sql_pub_janeiro = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '378'";
			$pub_janeiro = $wpdb->get_results($sql_pub_janeiro,ARRAY_A);
			echo "<td>".$pub_janeiro[0]['SUM(valor)']."</td>";

			$sql_ativ_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '378'";
			$ativ_janeiro = $wpdb->get_results($sql_ativ_janeiro,ARRAY_A);
			echo "<td>".$ativ_janeiro[0]['COUNT(id)']."</td>";

			$sql_age_janeiro = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_janeiro = $wpdb->get_results($sql_age_janeiro,ARRAY_A);
			echo "<td>".$age_janeiro[0]['COUNT(id)']."</td>";

			$sql_num_age_janeiro = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '378'";
			$num_age_janeiro = $wpdb->get_results($sql_num_age_janeiro,ARRAY_A);
			echo "<td>".$num_age_janeiro[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '378'";
			$num_bairros_janeiro = $wpdb->get_results($sql_num_bairros_janeiro,ARRAY_A);
			echo "<td>".$num_bairros_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_janeiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND publicado = '1' AND projeto = '378'";
			$per_bairros_janeiro = $wpdb->get_results($sql_per_bairros_janeiro,ARRAY_A);
			echo "<td>".$per_bairros_janeiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_janeiro = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio BETWEEN '2018-01-01' AND '2018-01-31' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_janeiro = $wpdb->get_results($sql_num_desc_janeiro,ARRAY_A);
			echo "<td>".$num_desc_janeiro[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_pub_total = "SELECT SUM(valor) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '378'";
			$pub_total= $wpdb->get_results($sql_pub_total,ARRAY_A);
			echo "<td>".$pub_total[0]['SUM(valor)']."</td>";

			$sql_ativ_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '378'";
			$ativ_total = $wpdb->get_results($sql_ativ_total,ARRAY_A);
			echo "<td>".$ativ_total[0]['COUNT(id)']."</td>";

			$sql_age_total = "SELECT COUNT(id) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND prof_sa = '1' AND projeto = '378'";
			$age_total = $wpdb->get_results($sql_age_total,ARRAY_A);
			echo "<td>".$age_total[0]['COUNT(id)']."</td>";

			$sql_num_age_total = "SELECT SUM(quantidade_prof_sa) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '378'";
			$num_age_total = $wpdb->get_results($sql_num_age_total,ARRAY_A);
			echo "<td>".$num_age_total[0]['SUM(quantidade_prof_sa)']."</td>";

			$sql_num_bairros_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '378'";
			$num_bairros_total = $wpdb->get_results($sql_num_bairros_total,ARRAY_A);
			echo "<td>".$num_bairros_total[0]['COUNT(DISTINCT(bairro))']."</td>";

			$sql_per_bairros_total = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND publicado = '1' AND projeto = '378'";
			$per_bairros_total = $wpdb->get_results($sql_per_bairros_total,ARRAY_A);
			echo "<td>".$per_bairros_total[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";

			$sql_num_desc_total = "SELECT COUNT(DISTINCT(bairro)) FROM sc_indicadores WHERE periodoInicio LIKE '%2018%' AND bairro NOT IN (574,583,648,660,578,651,576,587,652,649) AND publicado = '1' AND projeto = '378'";
			$num_desc_total = $wpdb->get_results($sql_num_desc_total,ARRAY_A);
			echo "<td>".$num_desc_total[0]['COUNT(DISTINCT(bairro))']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			<table class="table table-striped">
				<thead>
					...
					<tr>
						<th>Período</th>
 						<th>CEU Marek</th>
						<th>EMIA - Escola Municipal de Iniciação Artística Jaçatuba</th>
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_dez_emia = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_emia = $wpdb->get_results($sql_dez_emia,ARRAY_A);
			echo "<td>".$dez_emia[0]['SUM(dezembro)']."</td>";

			$sql_dez_elcv = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_elcv = $wpdb->get_results($sql_dez_elcv,ARRAY_A);
			echo "<td>".$dez_elcv[0]['SUM(dezembro)']."</td>";

			$sql_dez_eld = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_eld = $wpdb->get_results($sql_dez_eld,ARRAY_A);
			echo "<td>".$dez_eld[0]['SUM(dezembro)']."</td>";

			$sql_dez_elt = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_elt = $wpdb->get_results($sql_dez_elt,ARRAY_A);
			echo "<td>".$dez_elt[0]['SUM(dezembro)']."</td>";

			$sql_dez_territoriosc = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_dez_sa_emia = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_sa_emia = $wpdb->get_results($sql_dez_sa_emia,ARRAY_A);
			echo "<td>".$dez_sa_emia[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_elcv = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_sa_elcv = $wpdb->get_results($sql_dez_sa_elcv,ARRAY_A);
			echo "<td>".$dez_sa_elcv[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_eld = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_sa_eld = $wpdb->get_results($sql_dez_sa_eld,ARRAY_A);
			echo "<td>".$dez_sa_eld[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_elt = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$dez_sa_elt = $wpdb->get_results($sql_dez_sa_elt,ARRAY_A);
			echo "<td>".$dez_sa_elt[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_territoriosc = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_nov_emia = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_emia = $wpdb->get_results($sql_nov_emia,ARRAY_A);
			echo "<td>".$nov_emia[0]['SUM(novembro)']."</td>";

			$sql_nov_elcv = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_elcv = $wpdb->get_results($sql_nov_elcv,ARRAY_A);
			echo "<td>".$nov_elcv[0]['SUM(novembro)']."</td>";

			$sql_nov_eld = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_eld = $wpdb->get_results($sql_nov_eld,ARRAY_A);
			echo "<td>".$nov_eld[0]['SUM(novembro)']."</td>";

			$sql_nov_elt = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_elt = $wpdb->get_results($sql_nov_elt,ARRAY_A);
			echo "<td>".$nov_elt[0]['SUM(novembro)']."</td>";

			$sql_nov_territoriosc = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_nov_sa_emia = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_sa_emia = $wpdb->get_results($sql_nov_sa_emia,ARRAY_A);
			echo "<td>".$nov_sa_emia[0]['SUM(novembro_sa)']."</td>";

			$sql_nov_sa_elcv = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_sa_elcv = $wpdb->get_results($sql_nov_sa_elcv,ARRAY_A);
			echo "<td>".$nov_sa_elcv[0]['SUM(novembro_sa)']."</td>";	

			$sql_nov_sa_eld = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_sa_eld = $wpdb->get_results($sql_nov_sa_eld,ARRAY_A);
			echo "<td>".$nov_sa_eld[0]['SUM(novembro_sa)']."</td>";	

			$sql_nov_sa_elt = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$nov_sa_elt = $wpdb->get_results($sql_nov_sa_elt,ARRAY_A);
			echo "<td>".$nov_sa_elt[0]['SUM(novembro_sa)']."</td>";	

			$sql_nov_sa_territoriosc = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_out_emia = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_emia = $wpdb->get_results($sql_out_emia,ARRAY_A);
			echo "<td>".$out_emia[0]['SUM(outubro)']."</td>";

			$sql_out_elcv = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_elcv = $wpdb->get_results($sql_out_elcv,ARRAY_A);
			echo "<td>".$out_elcv[0]['SUM(outubro)']."</td>";

			$sql_out_eld = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_eld = $wpdb->get_results($sql_out_eld,ARRAY_A);
			echo "<td>".$out_eld[0]['SUM(outubro)']."</td>";

			$sql_out_elt = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_elt = $wpdb->get_results($sql_out_elt,ARRAY_A);
			echo "<td>".$out_elt[0]['SUM(outubro)']."</td>";

			$sql_out_territoriosc = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_out_sa_emia = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_sa_emia = $wpdb->get_results($sql_out_sa_emia,ARRAY_A);
			echo "<td>".$out_sa_emia[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_elcv = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_sa_elcv = $wpdb->get_results($sql_out_sa_elcv,ARRAY_A);
			echo "<td>".$out_sa_elcv[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_eld = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_sa_eld = $wpdb->get_results($sql_out_sa_eld,ARRAY_A);
			echo "<td>".$out_sa_eld[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_elt = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$out_sa_elt = $wpdb->get_results($sql_out_sa_elt,ARRAY_A);
			echo "<td>".$out_sa_elt[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_territoriosc = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_set_emia = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_emia = $wpdb->get_results($sql_set_emia,ARRAY_A);
			echo "<td>".$set_emia[0]['SUM(setembro)']."</td>";

			$sql_set_elcv = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_elcv = $wpdb->get_results($sql_set_elcv,ARRAY_A);
			echo "<td>".$set_elcv[0]['SUM(setembro)']."</td>";

			$sql_set_eld = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_eld = $wpdb->get_results($sql_set_eld,ARRAY_A);
			echo "<td>".$set_eld[0]['SUM(setembro)']."</td>";

			$sql_set_elt = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_elt = $wpdb->get_results($sql_set_elt,ARRAY_A);
			echo "<td>".$set_elt[0]['SUM(setembro)']."</td>";

			$sql_set_territoriosc = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_set_sa_emia = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_sa_emia = $wpdb->get_results($sql_set_sa_emia,ARRAY_A);
			echo "<td>".$set_sa_emia[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_elcv = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_sa_elcv = $wpdb->get_results($sql_set_sa_elcv,ARRAY_A);
			echo "<td>".$set_sa_elcv[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_eld = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_sa_eld = $wpdb->get_results($sql_set_sa_eld,ARRAY_A);
			echo "<td>".$set_sa_eld[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_elt = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '271' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$set_sa_elt = $wpdb->get_results($sql_set_sa_elt,ARRAY_A);
			echo "<td>".$set_sa_elt[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_territoriosc = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_ago_emia = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_emia = $wpdb->get_results($sql_ago_emia,ARRAY_A);
			echo "<td>".$ago_emia[0]['SUM(agosto)']."</td>";

			$sql_ago_elcv = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_elcv = $wpdb->get_results($sql_ago_elcv,ARRAY_A);
			echo "<td>".$ago_elcv[0]['SUM(agosto)']."</td>";

			$sql_ago_eld = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '204' AND 		ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_eld = $wpdb->get_results($sql_ago_eld,ARRAY_A);
			echo "<td>".$ago_eld[0]['SUM(agosto)']."</td>";

			$sql_ago_elt = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_elt = $wpdb->get_results($sql_ago_elt,ARRAY_A);
			echo "<td>".$ago_elt[0]['SUM(agosto)']."</td>";

			$sql_ago_territoriosc = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_ago_sa_emia = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_sa_emia = $wpdb->get_results($sql_ago_sa_emia,ARRAY_A);
			echo "<td>".$ago_sa_emia[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_elcv = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_sa_elcv = $wpdb->get_results($sql_ago_sa_elcv,ARRAY_A);
			echo "<td>".$ago_sa_elcv[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_eld = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_sa_eld = $wpdb->get_results($sql_ago_sa_eld,ARRAY_A);
			echo "<td>".$ago_sa_eld[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_elt = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$ago_sa_elt = $wpdb->get_results($sql_ago_sa_elt,ARRAY_A);
			echo "<td>".$ago_sa_elt[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_territoriosc = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_jul_emia = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_emia = $wpdb->get_results($sql_jul_emia,ARRAY_A);
			echo "<td>".$jul_emia[0]['SUM(julho)']."</td>";

			$sql_jul_elcv = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_elcv = $wpdb->get_results($sql_jul_elcv,ARRAY_A);
			echo "<td>".$jul_elcv[0]['SUM(julho)']."</td>";

			$sql_jul_eld = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_eld = $wpdb->get_results($sql_jul_eld,ARRAY_A);
			echo "<td>".$jul_eld[0]['SUM(julho)']."</td>";

			$sql_jul_elt = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_elt = $wpdb->get_results($sql_jul_elt,ARRAY_A);
			echo "<td>".$jul_elt[0]['SUM(julho)']."</td>";

			$sql_jul_territoriosc = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_jul_sa_emia = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_sa_emia = $wpdb->get_results($sql_jul_sa_emia,ARRAY_A);
			echo "<td>".$jul_sa_emia[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_elcv = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_sa_elcv = $wpdb->get_results($sql_jul_sa_elcv,ARRAY_A);
			echo "<td>".$jul_sa_elcv[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_eld = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_sa_eld = $wpdb->get_results($sql_jul_sa_eld,ARRAY_A);
			echo "<td>".$jul_sa_eld[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_elt = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jul_sa_elt = $wpdb->get_results($sql_jul_sa_elt,ARRAY_A);
			echo "<td>".$jul_sa_elt[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_territoriosc = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_jun_emia = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_emia = $wpdb->get_results($sql_jun_emia,ARRAY_A);
			echo "<td>".$jun_emia[0]['SUM(junho)']."</td>";

			$sql_jun_elcv = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_elcv = $wpdb->get_results($sql_jun_elcv,ARRAY_A);
			echo "<td>".$jun_elcv[0]['SUM(junho)']."</td>";

			$sql_jun_eld = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_eld = $wpdb->get_results($sql_jun_eld,ARRAY_A);
			echo "<td>".$jun_eld[0]['SUM(junho)']."</td>";

			$sql_jun_elt = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_elt = $wpdb->get_results($sql_jun_elt,ARRAY_A);
			echo "<td>".$jun_elt[0]['SUM(junho)']."</td>";

			$sql_jun_territoriosc = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_jun_sa_emia = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_sa_emia = $wpdb->get_results($sql_jun_sa_emia,ARRAY_A);
			echo "<td>".$jun_sa_emia[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_elcv = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_sa_elcv = $wpdb->get_results($sql_jun_sa_elcv,ARRAY_A);
			echo "<td>".$jun_sa_elcv[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_eld = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_sa_eld = $wpdb->get_results($sql_jun_sa_eld,ARRAY_A);
			echo "<td>".$jun_sa_eld[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_elt = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jun_sa_elt = $wpdb->get_results($sql_jun_sa_elt,ARRAY_A);
			echo "<td>".$jun_sa_elt[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_territoriosc = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_mai_emia = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_emia = $wpdb->get_results($sql_mai_emia,ARRAY_A);
			echo "<td>".$mai_emia[0]['SUM(maio)']."</td>";

			$sql_mai_elcv = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_elcv = $wpdb->get_results($sql_mai_elcv,ARRAY_A);
			echo "<td>".$mai_elcv[0]['SUM(maio)']."</td>";	

			$sql_mai_eld = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_eld = $wpdb->get_results($sql_mai_eld,ARRAY_A);
			echo "<td>".$mai_eld[0]['SUM(maio)']."</td>";

			$sql_mai_elt = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_elt = $wpdb->get_results($sql_mai_elt,ARRAY_A);
			echo "<td>".$mai_elt[0]['SUM(maio)']."</td>";

			$sql_mai_territoriosc = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_mai_sa_emia = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_sa_emia = $wpdb->get_results($sql_mai_sa_emia,ARRAY_A);
			echo "<td>".$mai_sa_emia[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_elcv = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_sa_elcv = $wpdb->get_results($sql_mai_sa_elcv,ARRAY_A);
			echo "<td>".$mai_sa_elcv[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_eld = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_sa_eld = $wpdb->get_results($sql_mai_sa_eld,ARRAY_A);
			echo "<td>".$mai_sa_eld[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_elt = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mai_sa_elt = $wpdb->get_results($sql_mai_sa_elt,ARRAY_A);
			echo "<td>".$mai_sa_elt[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_territoriosc = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_abr_emia = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_emia = $wpdb->get_results($sql_abr_emia,ARRAY_A);
			echo "<td>".$abr_emia[0]['SUM(abril)']."</td>";

			$sql_abr_elcv = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_elcv = $wpdb->get_results($sql_abr_elcv,ARRAY_A);
			echo "<td>".$abr_elcv[0]['SUM(abril)']."</td>";		

			$sql_abr_eld = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_eld = $wpdb->get_results($sql_abr_eld,ARRAY_A);
			echo "<td>".$abr_eld[0]['SUM(abril)']."</td>";

			$sql_abr_elt = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_elt = $wpdb->get_results($sql_abr_elt,ARRAY_A);
			echo "<td>".$abr_elt[0]['SUM(abril)']."</td>";

			$sql_abr_territoriosc = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_abr_sa_emia = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_sa_emia = $wpdb->get_results($sql_abr_sa_emia,ARRAY_A);
			echo "<td>".$abr_sa_emia[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_elcv = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_sa_elcv = $wpdb->get_results($sql_abr_sa_elcv,ARRAY_A);
			echo "<td>".$abr_sa_elcv[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_eld = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_sa_eld = $wpdb->get_results($sql_abr_sa_eld,ARRAY_A);
			echo "<td>".$abr_sa_eld[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_elt = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$abr_sa_elt = $wpdb->get_results($sql_abr_sa_elt,ARRAY_A);
			echo "<td>".$abr_sa_elt[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_territoriosc = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_mar_emia = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_emia = $wpdb->get_results($sql_mar_emia,ARRAY_A);
			echo "<td>".$mar_emia[0]['SUM(marco)']."</td>";		

			$sql_mar_elcv = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_elcv = $wpdb->get_results($sql_mar_elcv,ARRAY_A);
			echo "<td>".$mar_elcv[0]['SUM(marco)']."</td>";	

			$sql_mar_eld = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_eld = $wpdb->get_results($sql_mar_eld,ARRAY_A);
			echo "<td>".$mar_eld[0]['SUM(marco)']."</td>";

			$sql_mar_elt = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_elt = $wpdb->get_results($sql_mar_elt,ARRAY_A);
			echo "<td>".$mar_elt[0]['SUM(marco)']."</td>";

			$sql_mar_territoriosc = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_mar_sa_emia = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_sa_emia = $wpdb->get_results($sql_mar_sa_emia,ARRAY_A);
			echo "<td>".$mar_sa_emia[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_elcv = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_sa_elcv = $wpdb->get_results($sql_mar_sa_elcv,ARRAY_A);
			echo "<td>".$mar_sa_elcv[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_eld = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_sa_eld = $wpdb->get_results($sql_mar_sa_eld,ARRAY_A);
			echo "<td>".$mar_sa_eld[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_elt = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$mar_sa_elt = $wpdb->get_results($sql_mar_sa_elt,ARRAY_A);
			echo "<td>".$mar_sa_elt[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_territoriosc = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_fev_emia = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_emia = $wpdb->get_results($sql_fev_emia,ARRAY_A);
			echo "<td>".$fev_emia[0]['SUM(fevereiro)']."</td>";	

			$sql_fev_elcv = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_elcv = $wpdb->get_results($sql_fev_elcv,ARRAY_A);
			echo "<td>".$fev_elcv[0]['SUM(fevereiro)']."</td>";	

			$sql_fev_eld = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_eld = $wpdb->get_results($sql_fev_eld,ARRAY_A);
			echo "<td>".$fev_eld[0]['SUM(fevereiro)']."</td>";	

			$sql_fev_elt = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_elt = $wpdb->get_results($sql_fev_elt,ARRAY_A);
			echo "<td>".$fev_elt[0]['SUM(fevereiro)']."</td>";

			$sql_fev_territoriosc = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_fev_sa_emia = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_sa_emia = $wpdb->get_results($sql_fev_sa_emia,ARRAY_A);
			echo "<td>".$fev_sa_emia[0]['SUM(fevereiro_sa)']."</td>";			

			$sql_fev_sa_elcv = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_sa_elcv = $wpdb->get_results($sql_fev_sa_elcv,ARRAY_A);
			echo "<td>".$fev_sa_elcv[0]['SUM(fevereiro_sa)']."</td>";

			$sql_fev_sa_eld = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_sa_eld = $wpdb->get_results($sql_fev_sa_eld,ARRAY_A);
			echo "<td>".$fev_sa_eld[0]['SUM(fevereiro_sa)']."</td>";

			$sql_fev_sa_elt = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$fev_sa_elt = $wpdb->get_results($sql_fev_sa_elt,ARRAY_A);
			echo "<td>".$fev_sa_elt[0]['SUM(fevereiro_sa)']."</td>";

			$sql_fev_sa_territoriosc = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_jan_emia = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_emia = $wpdb->get_results($sql_jan_emia,ARRAY_A);
			echo "<td>".$jan_emia[0]['SUM(janeiro)']."</td>";

			$sql_jan_elcv = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_elcv = $wpdb->get_results($sql_jan_elcv,ARRAY_A);
			echo "<td>".$jan_elcv[0]['SUM(janeiro)']."</td>";

			$sql_jan_eld = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_eld = $wpdb->get_results($sql_jan_eld,ARRAY_A);
			echo "<td>".$jan_eld[0]['SUM(janeiro)']."</td>";

			$sql_jan_elt = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_elt = $wpdb->get_results($sql_jan_elt,ARRAY_A);
			echo "<td>".$jan_elt[0]['SUM(janeiro)']."</td>";

			$sql_jan_territoriosc = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_jan_sa_emia = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_sa_emia = $wpdb->get_results($sql_jan_sa_emia,ARRAY_A);
			echo "<td>".$jan_sa_emia[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_elcv = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_sa_elcv = $wpdb->get_results($sql_jan_sa_elcv,ARRAY_A);
			echo "<td>".$jan_sa_elcv[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_eld = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_sa_eld = $wpdb->get_results($sql_jan_sa_eld,ARRAY_A);
			echo "<td>".$jan_sa_eld[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_elt = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$jan_sa_elt = $wpdb->get_results($sql_jan_sa_elt,ARRAY_A);
			echo "<td>".$jan_sa_elt[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_territoriosc = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
		...
		echo "<tr>";
			...
			$sql_total_elt = "SELECT SUM(janeiro+fevereiro+marco+abril+maio+junho+julho+agosto+setembro+outubro+novembro+dezembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND publicado = '1'";
			$total_elt = $wpdb->get_results($sql_total_elt,ARRAY_A);
			echo "<td>".$total_elt[0]['SUM(janeiro+fevereiro+marco+abril+maio+junho+julho+agosto+setembro+outubro+novembro+dezembro)']."</td>";
		echo "</tr>";
		...
		<table class="table table-striped">
			<thead>
				<br>
				<label><h2>2019 - Por Projeto (Qtde. de ações)</h2></label>
				<tr>
					<th>Período</th>
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_dez_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND dezembro != '0' AND publicado = '1'";
		...
		echo "<tr>";
				echo "<td><strong>NOV</strong></td>";
			$sql_nov_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND novembro != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>OUT</strong></td>";
			$sql_out_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND outubro != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>SET</strong></td>";
			$sql_set_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND setembro != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>AGO</strong></td>";
			$sql_ago_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND agosto != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>JUL</strong></td>";		
			$sql_jul_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND julho != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>JUN</strong></td>";
			$sql_jun_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND junho != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>MAI</strong></td>";
			$sql_mai_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND maio != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>ABR</strong></td>";	
			$sql_abr_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND abril != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>MAR</strong></td>";	
			$sql_mar_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND marco != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>FEV</strong></td>";
			$sql_fev_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND fevereiro != '0' AND publicado = '1'";
		...
		echo "<tr>";
			echo "<td><strong>JAN</strong></td>";
			$sql_jan_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2019%' AND janeiro != '0' AND publicado = '1'";
...
echo "<tr>";
			...
			$sql_per_bairros_novembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND novembro > '0'";
			$per_bairros_novembro = $wpdb->get_results($sql_per_bairros_novembro,ARRAY_A);
			echo "<td>".$per_bairros_novembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_outubro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND outubro > '0'";
			$per_bairros_outubro = $wpdb->get_results($sql_per_bairros_outubro,ARRAY_A);
			echo "<td>".$per_bairros_outubro[0]['ROUND(COUNT(DISTINCT(bairro))*100/105,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_setembro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND setembro > '0'";
			$per_bairros_setembro = $wpdb->get_results($sql_per_bairros_setembro,ARRAY_A);
			echo "<td>".$per_bairros_setembro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_agosto = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND agosto > '0'";
			$per_bairros_agosto = $wpdb->get_results($sql_per_bairros_agosto,ARRAY_A);
			echo "<td>".$per_bairros_agosto[0]['ROUND(COUNT(DISTINCT(bairro))*100/105,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_julho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND julho > '0'";
			$per_bairros_julho = $wpdb->get_results($sql_per_bairros_julho,ARRAY_A);
			echo "<td>".$per_bairros_julho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_junho = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND junho > '0'";
			$per_bairros_junho = $wpdb->get_results($sql_per_bairros_junho,ARRAY_A);
			echo "<td>".$per_bairros_junho[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_maio = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND maio > '0'";
			$per_bairros_maio = $wpdb->get_results($sql_per_bairros_maio,ARRAY_A);
			echo "<td>".$per_bairros_maio[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_abril = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND abril > '0'";
			$per_bairros_abril = $wpdb->get_results($sql_per_bairros_abril,ARRAY_A);
			echo "<td>".$per_bairros_abril[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_marco = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND marco > '0'";
			$per_bairros_marco = $wpdb->get_results($sql_per_bairros_marco,ARRAY_A);
			echo "<td>".$per_bairros_marco[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_fevereiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND fevereiro > '0'";
			$per_bairros_fevereiro = $wpdb->get_results($sql_per_bairros_fevereiro,ARRAY_A);
			echo "<td>".$per_bairros_fevereiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
...
echo "<tr>";
			...
			$sql_per_bairros_janeiro = "SELECT ROUND(COUNT(DISTINCT(bairro))*100/112,2) FROM sc_ind_incentivo WHERE  ocor_inicio BETWEEN '2018-01-01' AND '2018-12-31' AND publicado = '1' AND janeiro > '0'";
			$per_bairros_janeiro = $wpdb->get_results($sql_per_bairros_janeiro,ARRAY_A);
			echo "<td>".$per_bairros_janeiro[0]['ROUND(COUNT(DISTINCT(bairro))*100/112,2)']."</td>";
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_dez_emia = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_emia = $wpdb->get_results($sql_dez_emia,ARRAY_A);
			echo "<td>".$dez_emia[0]['SUM(dezembro)']."</td>";

			$sql_dez_elcv = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_elcv = $wpdb->get_results($sql_dez_elcv,ARRAY_A);
			echo "<td>".$dez_elcv[0]['SUM(dezembro)']."</td>";

			$sql_dez_eld = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_eld = $wpdb->get_results($sql_dez_eld,ARRAY_A);
			echo "<td>".$dez_eld[0]['SUM(dezembro)']."</td>";

			$sql_dez_elt = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_elt = $wpdb->get_results($sql_dez_elt,ARRAY_A);
			echo "<td>".$dez_elt[0]['SUM(dezembro)']."</td>";

			$sql_dez_territoriosc = "SELECT SUM(dezembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_territoriosc = $wpdb->get_results($sql_dez_territoriosc,ARRAY_A);
			echo "<td>".$dez_territoriosc[0]['SUM(dezembro)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_dez_sa_emia = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_sa_emia = $wpdb->get_results($sql_dez_sa_emia,ARRAY_A);
			echo "<td>".$dez_sa_emia[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_elcv = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_sa_elcv = $wpdb->get_results($sql_dez_sa_elcv,ARRAY_A);
			echo "<td>".$dez_sa_elcv[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_eld = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_sa_eld = $wpdb->get_results($sql_dez_sa_eld,ARRAY_A);
			echo "<td>".$dez_sa_eld[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_elt = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_sa_elt = $wpdb->get_results($sql_dez_sa_elt,ARRAY_A);
			echo "<td>".$dez_sa_elt[0]['SUM(dezembro_sa)']."</td>";

			$sql_dez_sa_territoriosc = "SELECT SUM(dezembro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$dez_sa_territoriosc = $wpdb->get_results($sql_dez_sa_territoriosc,ARRAY_A);
			echo "<td>".$dez_sa_territoriosc[0]['SUM(dezembro_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_nov_emia = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_emia = $wpdb->get_results($sql_nov_emia,ARRAY_A);
			echo "<td>".$nov_emia[0]['SUM(novembro)']."</td>";

			$sql_nov_elcv = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_elcv = $wpdb->get_results($sql_nov_elcv,ARRAY_A);
			echo "<td>".$nov_elcv[0]['SUM(novembro)']."</td>";

			$sql_nov_eld = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_eld = $wpdb->get_results($sql_nov_eld,ARRAY_A);
			echo "<td>".$nov_eld[0]['SUM(novembro)']."</td>";

			$sql_nov_elt = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_elt = $wpdb->get_results($sql_nov_elt,ARRAY_A);
			echo "<td>".$nov_elt[0]['SUM(novembro)']."</td>";

			$sql_nov_territoriosc = "SELECT SUM(novembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_territoriosc = $wpdb->get_results($sql_nov_territoriosc,ARRAY_A);
			echo "<td>".$nov_territoriosc[0]['SUM(novembro)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_nov_sa_emia = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_sa_emia = $wpdb->get_results($sql_nov_sa_emia,ARRAY_A);
			echo "<td>".$nov_sa_emia[0]['SUM(novembro_sa)']."</td>";

			$sql_nov_sa_elcv = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_sa_elcv = $wpdb->get_results($sql_nov_sa_elcv,ARRAY_A);
			echo "<td>".$nov_sa_elcv[0]['SUM(novembro_sa)']."</td>";	

			$sql_nov_sa_eld = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_sa_eld = $wpdb->get_results($sql_nov_sa_eld,ARRAY_A);
			echo "<td>".$nov_sa_eld[0]['SUM(novembro_sa)']."</td>";	

			$sql_nov_sa_elt = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_sa_elt = $wpdb->get_results($sql_nov_sa_elt,ARRAY_A);
			echo "<td>".$nov_sa_elt[0]['SUM(novembro_sa)']."</td>";	

			$sql_nov_sa_territoriosc = "SELECT SUM(novembro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$nov_sa_territoriosc = $wpdb->get_results($sql_nov_sa_territoriosc,ARRAY_A);
			echo "<td>".$nov_sa_territoriosc[0]['SUM(novembro_sa)']."</td>";	
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_out_emia = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_emia = $wpdb->get_results($sql_out_emia,ARRAY_A);
			echo "<td>".$out_emia[0]['SUM(outubro)']."</td>";

			$sql_out_elcv = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_elcv = $wpdb->get_results($sql_out_elcv,ARRAY_A);
			echo "<td>".$out_elcv[0]['SUM(outubro)']."</td>";

			$sql_out_eld = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_eld = $wpdb->get_results($sql_out_eld,ARRAY_A);
			echo "<td>".$out_eld[0]['SUM(outubro)']."</td>";

			$sql_out_elt = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_elt = $wpdb->get_results($sql_out_elt,ARRAY_A);
			echo "<td>".$out_elt[0]['SUM(outubro)']."</td>";

			$sql_out_territoriosc = "SELECT SUM(outubro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_territoriosc = $wpdb->get_results($sql_out_territoriosc,ARRAY_A);
			echo "<td>".$out_territoriosc[0]['SUM(outubro)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_out_sa_emia = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_sa_emia = $wpdb->get_results($sql_out_sa_emia,ARRAY_A);
			echo "<td>".$out_sa_emia[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_elcv = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_sa_elcv = $wpdb->get_results($sql_out_sa_elcv,ARRAY_A);
			echo "<td>".$out_sa_elcv[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_eld = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_sa_eld = $wpdb->get_results($sql_out_sa_eld,ARRAY_A);
			echo "<td>".$out_sa_eld[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_elt = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_sa_elt = $wpdb->get_results($sql_out_sa_elt,ARRAY_A);
			echo "<td>".$out_sa_elt[0]['SUM(outubro_sa)']."</td>";

			$sql_out_sa_territoriosc = "SELECT SUM(outubro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$out_sa_territoriosc = $wpdb->get_results($sql_out_sa_territoriosc,ARRAY_A);
			echo "<td>".$out_sa_territoriosc[0]['SUM(outubro_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_set_emia = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_emia = $wpdb->get_results($sql_set_emia,ARRAY_A);
			echo "<td>".$set_emia[0]['SUM(setembro)']."</td>";

			$sql_set_elcv = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_elcv = $wpdb->get_results($sql_set_elcv,ARRAY_A);
			echo "<td>".$set_elcv[0]['SUM(setembro)']."</td>";

			$sql_set_eld = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_eld = $wpdb->get_results($sql_set_eld,ARRAY_A);
			echo "<td>".$set_eld[0]['SUM(setembro)']."</td>";

			$sql_set_elt = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_elt = $wpdb->get_results($sql_set_elt,ARRAY_A);
			echo "<td>".$set_elt[0]['SUM(setembro)']."</td>";

			$sql_set_territoriosc = "SELECT SUM(setembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_territoriosc = $wpdb->get_results($sql_set_territoriosc,ARRAY_A);
			echo "<td>".$set_territoriosc[0]['SUM(setembro)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_set_sa_emia = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_sa_emia = $wpdb->get_results($sql_set_sa_emia,ARRAY_A);
			echo "<td>".$set_sa_emia[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_elcv = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_sa_elcv = $wpdb->get_results($sql_set_sa_elcv,ARRAY_A);
			echo "<td>".$set_sa_elcv[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_eld = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_sa_eld = $wpdb->get_results($sql_set_sa_eld,ARRAY_A);
			echo "<td>".$set_sa_eld[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_elt = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE equipamento = '271' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_sa_elt = $wpdb->get_results($sql_set_sa_elt,ARRAY_A);
			echo "<td>".$set_sa_elt[0]['SUM(setembro_sa)']."</td>";

			$sql_set_sa_territoriosc = "SELECT SUM(setembro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$set_sa_territoriosc = $wpdb->get_results($sql_set_sa_territoriosc,ARRAY_A);
			echo "<td>".$set_sa_territoriosc[0]['SUM(setembro_sa)']."</td>";
...
echo "<tr>";
			...
			$sql_ago_emia = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_emia = $wpdb->get_results($sql_ago_emia,ARRAY_A);
			echo "<td>".$ago_emia[0]['SUM(agosto)']."</td>";

			$sql_ago_elcv = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_elcv = $wpdb->get_results($sql_ago_elcv,ARRAY_A);
			echo "<td>".$ago_elcv[0]['SUM(agosto)']."</td>";

			$sql_ago_eld = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '204' AND 		ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_eld = $wpdb->get_results($sql_ago_eld,ARRAY_A);
			echo "<td>".$ago_eld[0]['SUM(agosto)']."</td>";

			$sql_ago_elt = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_elt = $wpdb->get_results($sql_ago_elt,ARRAY_A);
			echo "<td>".$ago_elt[0]['SUM(agosto)']."</td>";

			$sql_ago_territoriosc = "SELECT SUM(agosto) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_territoriosc = $wpdb->get_results($sql_ago_territoriosc,ARRAY_A);
			echo "<td>".$ago_territoriosc[0]['SUM(agosto)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_ago_sa_emia = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_sa_emia = $wpdb->get_results($sql_ago_sa_emia,ARRAY_A);
			echo "<td>".$ago_sa_emia[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_elcv = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_sa_elcv = $wpdb->get_results($sql_ago_sa_elcv,ARRAY_A);
			echo "<td>".$ago_sa_elcv[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_eld = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_sa_eld = $wpdb->get_results($sql_ago_sa_eld,ARRAY_A);
			echo "<td>".$ago_sa_eld[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_elt = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_sa_elt = $wpdb->get_results($sql_ago_sa_elt,ARRAY_A);
			echo "<td>".$ago_sa_elt[0]['SUM(agosto_sa)']."</td>";

			$sql_ago_sa_territoriosc = "SELECT SUM(agosto_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$ago_sa_territoriosc = $wpdb->get_results($sql_ago_sa_territoriosc,ARRAY_A);
			echo "<td>".$ago_sa_territoriosc[0]['SUM(agosto_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_jul_emia = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_emia = $wpdb->get_results($sql_jul_emia,ARRAY_A);
			echo "<td>".$jul_emia[0]['SUM(julho)']."</td>";

			$sql_jul_elcv = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_elcv = $wpdb->get_results($sql_jul_elcv,ARRAY_A);
			echo "<td>".$jul_elcv[0]['SUM(julho)']."</td>";

			$sql_jul_eld = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_eld = $wpdb->get_results($sql_jul_eld,ARRAY_A);
			echo "<td>".$jul_eld[0]['SUM(julho)']."</td>";

			$sql_jul_elt = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_elt = $wpdb->get_results($sql_jul_elt,ARRAY_A);
			echo "<td>".$jul_elt[0]['SUM(julho)']."</td>";

			$sql_jul_territoriosc = "SELECT SUM(julho) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_territoriosc = $wpdb->get_results($sql_jul_territoriosc,ARRAY_A);
			echo "<td>".$jul_territoriosc[0]['SUM(julho)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_jul_sa_emia = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_sa_emia = $wpdb->get_results($sql_jul_sa_emia,ARRAY_A);
			echo "<td>".$jul_sa_emia[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_elcv = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_sa_elcv = $wpdb->get_results($sql_jul_sa_elcv,ARRAY_A);
			echo "<td>".$jul_sa_elcv[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_eld = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_sa_eld = $wpdb->get_results($sql_jul_sa_eld,ARRAY_A);
			echo "<td>".$jul_sa_eld[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_elt = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_sa_elt = $wpdb->get_results($sql_jul_sa_elt,ARRAY_A);
			echo "<td>".$jul_sa_elt[0]['SUM(julho_sa)']."</td>";

			$sql_jul_sa_territoriosc = "SELECT SUM(julho_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jul_sa_territoriosc = $wpdb->get_results($sql_jul_sa_territoriosc,ARRAY_A);
			echo "<td>".$jul_sa_territoriosc[0]['SUM(julho_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_jun_emia = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_emia = $wpdb->get_results($sql_jun_emia,ARRAY_A);
			echo "<td>".$jun_emia[0]['SUM(junho)']."</td>";

			$sql_jun_elcv = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_elcv = $wpdb->get_results($sql_jun_elcv,ARRAY_A);
			echo "<td>".$jun_elcv[0]['SUM(junho)']."</td>";

			$sql_jun_eld = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_eld = $wpdb->get_results($sql_jun_eld,ARRAY_A);
			echo "<td>".$jun_eld[0]['SUM(junho)']."</td>";

			$sql_jun_elt = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_elt = $wpdb->get_results($sql_jun_elt,ARRAY_A);
			echo "<td>".$jun_elt[0]['SUM(junho)']."</td>";

			$sql_jun_territoriosc = "SELECT SUM(junho) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_territoriosc = $wpdb->get_results($sql_jun_territoriosc,ARRAY_A);
			echo "<td>".$jun_territoriosc[0]['SUM(junho)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_jun_sa_emia = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_sa_emia = $wpdb->get_results($sql_jun_sa_emia,ARRAY_A);
			echo "<td>".$jun_sa_emia[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_elcv = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_sa_elcv = $wpdb->get_results($sql_jun_sa_elcv,ARRAY_A);
			echo "<td>".$jun_sa_elcv[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_eld = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_sa_eld = $wpdb->get_results($sql_jun_sa_eld,ARRAY_A);
			echo "<td>".$jun_sa_eld[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_elt = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_sa_elt = $wpdb->get_results($sql_jun_sa_elt,ARRAY_A);
			echo "<td>".$jun_sa_elt[0]['SUM(junho_sa)']."</td>";

			$sql_jun_sa_territoriosc = "SELECT SUM(junho_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jun_sa_territoriosc = $wpdb->get_results($sql_jun_sa_territoriosc,ARRAY_A);
			echo "<td>".$jun_sa_territoriosc[0]['SUM(junho_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_mai_emia = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_emia = $wpdb->get_results($sql_mai_emia,ARRAY_A);
			echo "<td>".$mai_emia[0]['SUM(maio)']."</td>";

			$sql_mai_elcv = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_elcv = $wpdb->get_results($sql_mai_elcv,ARRAY_A);
			echo "<td>".$mai_elcv[0]['SUM(maio)']."</td>";	

			$sql_mai_eld = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_eld = $wpdb->get_results($sql_mai_eld,ARRAY_A);
			echo "<td>".$mai_eld[0]['SUM(maio)']."</td>";

			$sql_mai_elt = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_elt = $wpdb->get_results($sql_mai_elt,ARRAY_A);
			echo "<td>".$mai_elt[0]['SUM(maio)']."</td>";

			$sql_mai_territoriosc = "SELECT SUM(maio) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_territoriosc = $wpdb->get_results($sql_mai_territoriosc,ARRAY_A);
			echo "<td>".$mai_territoriosc[0]['SUM(maio)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_mai_sa_emia = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_sa_emia = $wpdb->get_results($sql_mai_sa_emia,ARRAY_A);
			echo "<td>".$mai_sa_emia[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_elcv = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_sa_elcv = $wpdb->get_results($sql_mai_sa_elcv,ARRAY_A);
			echo "<td>".$mai_sa_elcv[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_eld = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_sa_eld = $wpdb->get_results($sql_mai_sa_eld,ARRAY_A);
			echo "<td>".$mai_sa_eld[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_elt = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_sa_elt = $wpdb->get_results($sql_mai_sa_elt,ARRAY_A);
			echo "<td>".$mai_sa_elt[0]['SUM(maio_sa)']."</td>";

			$sql_mai_sa_territoriosc = "SELECT SUM(maio_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mai_sa_territoriosc = $wpdb->get_results($sql_mai_sa_territoriosc,ARRAY_A);
			echo "<td>".$mai_sa_territoriosc[0]['SUM(maio_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_abr_emia = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_emia = $wpdb->get_results($sql_abr_emia,ARRAY_A);
			echo "<td>".$abr_emia[0]['SUM(abril)']."</td>";

			$sql_abr_elcv = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_elcv = $wpdb->get_results($sql_abr_elcv,ARRAY_A);
			echo "<td>".$abr_elcv[0]['SUM(abril)']."</td>";		

			$sql_abr_eld = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_eld = $wpdb->get_results($sql_abr_eld,ARRAY_A);
			echo "<td>".$abr_eld[0]['SUM(abril)']."</td>";

			$sql_abr_elt = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_elt = $wpdb->get_results($sql_abr_elt,ARRAY_A);
			echo "<td>".$abr_elt[0]['SUM(abril)']."</td>";

			$sql_abr_territoriosc = "SELECT SUM(abril) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_territoriosc = $wpdb->get_results($sql_abr_territoriosc,ARRAY_A);
			echo "<td>".$abr_territoriosc[0]['SUM(abril)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_abr_sa_emia = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_sa_emia = $wpdb->get_results($sql_abr_sa_emia,ARRAY_A);
			echo "<td>".$abr_sa_emia[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_elcv = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_sa_elcv = $wpdb->get_results($sql_abr_sa_elcv,ARRAY_A);
			echo "<td>".$abr_sa_elcv[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_eld = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_sa_eld = $wpdb->get_results($sql_abr_sa_eld,ARRAY_A);
			echo "<td>".$abr_sa_eld[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_elt = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_sa_elt = $wpdb->get_results($sql_abr_sa_elt,ARRAY_A);
			echo "<td>".$abr_sa_elt[0]['SUM(abril_sa)']."</td>";

			$sql_abr_sa_territoriosc = "SELECT SUM(abril_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$abr_sa_territoriosc = $wpdb->get_results($sql_abr_sa_territoriosc,ARRAY_A);
			echo "<td>".$abr_sa_territoriosc[0]['SUM(abril_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_mar_emia = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_emia = $wpdb->get_results($sql_mar_emia,ARRAY_A);
			echo "<td>".$mar_emia[0]['SUM(marco)']."</td>";		

			$sql_mar_elcv = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_elcv = $wpdb->get_results($sql_mar_elcv,ARRAY_A);
			echo "<td>".$mar_elcv[0]['SUM(marco)']."</td>";	

			$sql_mar_eld = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_eld = $wpdb->get_results($sql_mar_eld,ARRAY_A);
			echo "<td>".$mar_eld[0]['SUM(marco)']."</td>";

			$sql_mar_elt = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_elt = $wpdb->get_results($sql_mar_elt,ARRAY_A);
			echo "<td>".$mar_elt[0]['SUM(marco)']."</td>";

			$sql_mar_territoriosc = "SELECT SUM(marco) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_territoriosc = $wpdb->get_results($sql_mar_territoriosc,ARRAY_A);
			echo "<td>".$mar_territoriosc[0]['SUM(marco)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_mar_sa_emia = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_sa_emia = $wpdb->get_results($sql_mar_sa_emia,ARRAY_A);
			echo "<td>".$mar_sa_emia[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_elcv = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_sa_elcv = $wpdb->get_results($sql_mar_sa_elcv,ARRAY_A);
			echo "<td>".$mar_sa_elcv[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_eld = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_sa_eld = $wpdb->get_results($sql_mar_sa_eld,ARRAY_A);
			echo "<td>".$mar_sa_eld[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_elt = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_sa_elt = $wpdb->get_results($sql_mar_sa_elt,ARRAY_A);
			echo "<td>".$mar_sa_elt[0]['SUM(marco_sa)']."</td>";

			$sql_mar_sa_territoriosc = "SELECT SUM(marco_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$mar_sa_territoriosc = $wpdb->get_results($sql_mar_sa_territoriosc,ARRAY_A);
			echo "<td>".$mar_sa_territoriosc[0]['SUM(marco_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_fev_emia = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_emia = $wpdb->get_results($sql_fev_emia,ARRAY_A);
			echo "<td>".$fev_emia[0]['SUM(fevereiro)']."</td>";	

			$sql_fev_elcv = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_elcv = $wpdb->get_results($sql_fev_elcv,ARRAY_A);
			echo "<td>".$fev_elcv[0]['SUM(fevereiro)']."</td>";	

			$sql_fev_eld = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_eld = $wpdb->get_results($sql_fev_eld,ARRAY_A);
			echo "<td>".$fev_eld[0]['SUM(fevereiro)']."</td>";	

			$sql_fev_elt = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_elt = $wpdb->get_results($sql_fev_elt,ARRAY_A);
			echo "<td>".$fev_elt[0]['SUM(fevereiro)']."</td>";

			$sql_fev_territoriosc = "SELECT SUM(fevereiro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_territoriosc = $wpdb->get_results($sql_fev_territoriosc,ARRAY_A);
			echo "<td>".$fev_territoriosc[0]['SUM(fevereiro)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_fev_sa_emia = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_sa_emia = $wpdb->get_results($sql_fev_sa_emia,ARRAY_A);
			echo "<td>".$fev_sa_emia[0]['SUM(fevereiro_sa)']."</td>";			

			$sql_fev_sa_elcv = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_sa_elcv = $wpdb->get_results($sql_fev_sa_elcv,ARRAY_A);
			echo "<td>".$fev_sa_elcv[0]['SUM(fevereiro_sa)']."</td>";

			$sql_fev_sa_eld = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_sa_eld = $wpdb->get_results($sql_fev_sa_eld,ARRAY_A);
			echo "<td>".$fev_sa_eld[0]['SUM(fevereiro_sa)']."</td>";

			$sql_fev_sa_elt = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_sa_elt = $wpdb->get_results($sql_fev_sa_elt,ARRAY_A);
			echo "<td>".$fev_sa_elt[0]['SUM(fevereiro_sa)']."</td>";

			$sql_fev_sa_territoriosc = "SELECT SUM(fevereiro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$fev_sa_territoriosc = $wpdb->get_results($sql_fev_sa_territoriosc,ARRAY_A);
			echo "<td>".$fev_sa_territoriosc[0]['SUM(fevereiro_sa)']."</td>";
		echo "</tr>";
...
echo "<tr>";
			...
			$sql_jan_emia = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_emia = $wpdb->get_results($sql_jan_emia,ARRAY_A);
			echo "<td>".$jan_emia[0]['SUM(janeiro)']."</td>";

			$sql_jan_elcv = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_elcv = $wpdb->get_results($sql_jan_elcv,ARRAY_A);
			echo "<td>".$jan_elcv[0]['SUM(janeiro)']."</td>";

			$sql_jan_eld = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_eld = $wpdb->get_results($sql_jan_eld,ARRAY_A);
			echo "<td>".$jan_eld[0]['SUM(janeiro)']."</td>";

			$sql_jan_elt = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_elt = $wpdb->get_results($sql_jan_elt,ARRAY_A);
			echo "<td>".$jan_elt[0]['SUM(janeiro)']."</td>";

			$sql_jan_territoriosc = "SELECT SUM(janeiro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_territoriosc = $wpdb->get_results($sql_jan_territoriosc,ARRAY_A);
			echo "<td>".$jan_territoriosc[0]['SUM(janeiro)']."</td>";	
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_jan_sa_emia = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '205' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_sa_emia = $wpdb->get_results($sql_jan_sa_emia,ARRAY_A);
			echo "<td>".$jan_sa_emia[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_elcv = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '206' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_sa_elcv = $wpdb->get_results($sql_jan_sa_elcv,ARRAY_A);
			echo "<td>".$jan_sa_elcv[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_eld = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '204' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_sa_eld = $wpdb->get_results($sql_jan_sa_eld,ARRAY_A);
			echo "<td>".$jan_sa_eld[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_elt = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE equipamento = '283' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_sa_elt = $wpdb->get_results($sql_jan_sa_elt,ARRAY_A);
			echo "<td>".$jan_sa_elt[0]['SUM(janeiro_sa)']."</td>";

			$sql_jan_sa_territoriosc = "SELECT SUM(janeiro_sa) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$jan_sa_territoriosc = $wpdb->get_results($sql_jan_sa_territoriosc,ARRAY_A);
			echo "<td>".$jan_sa_territoriosc[0]['SUM(janeiro_sa)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			$sql_total_elt = "SELECT SUM(janeiro+fevereiro+marco+abril+maio+junho+julho+agosto+setembro+outubro+novembro+dezembro) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND publicado = '1'";
			$total_elt = $wpdb->get_results($sql_total_elt,ARRAY_A);
			echo "<td>".$total_elt[0]['SUM(janeiro+fevereiro+marco+abril+maio+junho+julho+agosto+setembro+outubro+novembro+dezembro)']."</td>";
		echo "</tr>";
		...
		<table class="table table-striped">
			<thead>
				<br>
				<label><h2>2018 - Por Projeto (Qtde. de ações)</h2></label>
				<tr>
					<th>Período</th>
					<th>Projeto Territórios de Cultura</th>
				</tr>
	...
	<?php
		...
		echo "<tr>";
			...
			$sql_dez_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND dezembro != '0' AND publicado = '1'";
			$dez_territorios = $wpdb->get_results($sql_dez_territorios,ARRAY_A);
			echo "<td>".$dez_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
				echo "<td><strong>NOV</strong></td>";
			$sql_nov_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND novembro != '0' AND publicado = '1'";
			$nov_territorios = $wpdb->get_results($sql_nov_territorios,ARRAY_A);
			echo "<td>".$nov_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";
		...
		echo "<tr>";
			echo "<td><strong>OUT</strong></td>";
			$sql_out_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND outubro != '0' AND publicado = '1'";
			$out_territorios = $wpdb->get_results($sql_out_territorios,ARRAY_A);
			echo "<td>".$out_territorios[0]['COUNT(id)']."</td>";	
		echo "</tr>";
		...
		echo "<tr>";
			echo "<td><strong>SET</strong></td>";
			$sql_set_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND setembro != '0' AND publicado = '1'";
			$set_territorios = $wpdb->get_results($sql_set_territorios,ARRAY_A);
			echo "<td>".$set_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>AGO</strong></td>";
			$sql_ago_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND agosto != '0' AND publicado = '1'";
			$ago_territorios = $wpdb->get_results($sql_ago_territorios,ARRAY_A);
			echo "<td>".$ago_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>JUL</strong></td>";		
			$sql_jul_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND julho != '0' AND publicado = '1'";
			$jul_territorios = $wpdb->get_results($sql_jul_territorios,ARRAY_A);
			echo "<td>".$jul_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>JUN</strong></td>";
			$sql_jun_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND junho != '0' AND publicado = '1'";
			$jun_territorios = $wpdb->get_results($sql_jun_territorios,ARRAY_A);
			echo "<td>".$jun_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>MAI</strong></td>";
			$sql_mai_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND maio != '0' AND publicado = '1'";
			$mai_territorios = $wpdb->get_results($sql_mai_territorios,ARRAY_A);
			echo "<td>".$mai_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>ABR</strong></td>";	
			$sql_abr_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND abril != '0' AND publicado = '1'";
			$abr_territorios = $wpdb->get_results($sql_abr_territorios,ARRAY_A);
			echo "<td>".$abr_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>MAR</strong></td>";	
			$sql_mar_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND marco != '0' AND publicado = '1'";
			$mar_territorios = $wpdb->get_results($sql_mar_territorios,ARRAY_A);
			echo "<td>".$mar_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>FEV</strong></td>";
			$sql_fev_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND fevereiro != '0' AND publicado = '1'";
			$fev_territorios = $wpdb->get_results($sql_fev_territorios,ARRAY_A);
			echo "<td>".$fev_territorios[0]['COUNT(id)']."</td>";
		echo "</tr>";	
		...
		echo "<tr>";
			echo "<td><strong>JAN</strong></td>";
			$sql_jan_territorios = "SELECT COUNT(id) FROM sc_ind_incentivo WHERE projeto = '792' AND ocor_inicio LIKE '%2018%' AND janeiro != '0' AND publicado = '1'";
			$jan_territorios = $wpdb->get_results($sql_jan_territorios,ARRAY_A);
			echo "<td>".$jan_territorios[0]['COUNT(id)']."</td>";
			echo "</tr>";
		echo "</tr>";	
		...
		<form class="formocor" action="?p=listarinscricoes" method="POST" role="form">
			...
			<div class="form-group">
				<div class="col-md-offset-2 col-md-8">
					...
					<input type="text" name="rascunhos" class="form-control" value="" />
				</div>
			</div>	
			<div class="form-group">
				<div class="col-md-offset-2 col-md-8">
			...
			<div class="form-group">
				<div class="col-md-offset-2 col-md-8">
					...
					<input type="text" name="selecionados" class="form-control" value="" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-offset-2 col-md-8">
					<label>Contratados</label>
					<input type="text" name="contratados" class="form-control" value="" />
				</div>
			</div>
		...
		<form class="formocor" action="?p=editarinscricoes" method="POST" role="form">
			<div class="form-group">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
						<label>Rascunhos</label>
						<input type="text" name="rascunhos" class="form-control" value="<?php echo $ind['rascunhos']; ?>" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-offset-2 col-md-8">
