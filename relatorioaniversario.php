...
<div class="margem">
	...
	<div>
		...
		$sql_cat = "SELECT DISTINCT filtro FROM ava_ranking WHERE edital = '273' ORDER BY filtro ASC";
		...
		for($i = 0; $i < count($res_cat); $i++){
			...
			<table border= "1" class="table table-striped">
				...
				<tbody>
					...
					<?php 
					$sql_ins = "SELECT inscricao,nota FROM ava_ranking WHERE filtro = '$filtro' AND edital = '273' ORDER BY nota DESC";
					...
					for($k = 0; $k < count($res_ins); $k++){		
						...
						<tr>
							...
							<td><?php echo retornaNota2Fase($inscricao,'274'); ?></td>
