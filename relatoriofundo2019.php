...
<div class="margem"> 
	...
	<div>
		...
		$sql_cat = "SELECT DISTINCT filtro FROM ava_ranking WHERE edital = '445' ORDER BY filtro ASC";
		...
		for($i = 0; $i < count($res_cat); $i++){
			...
			<table border= "1" class="table table-striped">
				...
				<tbody>
					...
					<?php 
					$sql_ins = "SELECT inscricao,nota FROM ava_ranking WHERE filtro = '$filtro' AND edital = '445'  ORDER BY nota DESC";
					...
					for($k = 0; $k < count($res_ins); $k++){		
						...
						<tr>
							...
							<td><?php echo retornaNota2Fase($inscricao,'446'); ?></td>
							<td><?php echo $res_ins[$k]['nota']; ?></td>
							<td><?php echo retornaAnotacao($inscricao,1,'446'); ?></td>
						</tr>			  
	...
	<br /><br /><br />
	<p>-------------------------------------------------------------- <br />
	José Bertholini Vericondo </p><br /><br />
	<p>-------------------------------------------------------------- <br />
	Jurema Barreto de Souza</p><br /><br />
</div>