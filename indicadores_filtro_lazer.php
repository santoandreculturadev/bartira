<?php 		   
		...
		<body>
			...
			<div class="col-md-offset-2 col-md-8">
				<h3>Incentivo à Criação - LAZER - Visualizar Disciplinas</h3>
							...
							<div class="col-md-offset-2">
								...
								<select class="form-control" name="ano_base" id="inputSubject" >
									<option value='0'>Escolha uma opção</option>
																					<?php 
													anoBaseIndicadores("sc_ind_incentivo",$ano_base);
		...
		<?php 
		$sel = "SELECT * FROM sc_ind_incentivo WHERE publicado = '1' AND projeto IN (378,723) $$sql_ano_base ORDER BY ocor_inicio DESC";
