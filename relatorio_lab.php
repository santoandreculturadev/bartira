...
<div class="margem">
    ...
    <div>
        ...
        $sql_cat = "SELECT DISTINCT filtro FROM ava_ranking WHERE edital = '797' ORDER BY filtro ASC";
        ...
        for($i = 0; $i < count($res_cat); $i++){
            ...
            <table border= "1" class="table table-striped">
                ...
                <?php
                $sql_ins = "SELECT inscricao,nota FROM ava_ranking WHERE filtro = '$filtro' AND edital = '797'  ORDER BY nota DESC";
                ...
                for($k = 0; $k < count($res_ins); $k++){
                    ...
                    $nota = nota($inscricao,797);
                    ?>

                    <tr>
                        <td><?php echo $res_json['2.2 TÍTULO DO PROJETO']; ?></td>
                        ...
                        <td><?php echo retornaAnotacao($inscricao,1,'797'); ?></td>
                    </tr>
