    ...
    <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
      ...
      <?php
        ...
        <?php ?>
          ...
          <?php
          $peruser = array(1,5,13,16,17,39,142,42,49,52,34,33,28,18,53,77,38,63,70,71,72,75,76,79,88,90,35,47,26,46,48,79,12,45,56,144,41,145,68,69,66,145,151,152,153,154,156,158,159,202,160,198);
          if(in_array($user->ID,$peruser)){ ?>       
            <li class="nav-item">
          ...
          <?php } ?>
		            <?php
          $peruser = array(1,5,13,16,17,39,142,42,49,52,34,33,28,18,53,77,63,38,70,71,72,75,76,79,88,90,35,47,26,46,48,79,12,45,56,144,41,145,68,69,66,145,151,152,153,154,156,158,159,,202,160,198);
          if(in_array($user->ID,$peruser)){ ?>       
            <li class="nav-item">
