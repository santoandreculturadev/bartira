		...
		<tbody>
			<?php 
				...
				for($i = 0; $i < count($res_programa); $i++){
					...
					<?php // Projeto
					$sel_projeto = "SELECT * FROM sc_tipo WHERE abreviatura = 'projeto' AND publicado = '1' AND ano_base = '2018'";
...
<table border = '1' width='100%'>
	...
	for ($i = 0; $i < count($programa); $i++){ 
		...
		<tr>
			...
			?></td>
			<td align='right'><?php 
			$e = somaPrograma($programa[$i]['id'],'2018');
...
<!-- Gráfico Planejamento por Programa -->
